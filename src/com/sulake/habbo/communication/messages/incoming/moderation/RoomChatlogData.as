package com.sulake.habbo.communication.messages.incoming.moderation
{
   ...
   public class RoomChatlogData
   {
      ...
      public function RoomChatlogData(param1:IMessageDataWrapper)
      {
         ...
         while(_loc3_ < _loc2_)
         {
            this.var_1882.push(new ChatlineData(param1));
            _loc3_++;
         }
         Logger.log("READ ROOMCHATLOGDATA: " + this.var_1881 + ", " + this._roomId + ", " + this.var_952 + ", " + this.chatlog.length);
      }
