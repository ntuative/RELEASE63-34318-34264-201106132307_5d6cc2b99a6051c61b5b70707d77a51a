package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2631:PseudoRandom;
      ...
      private var var_247:HabboHotelView;
      
      private var var_1572:String = "";
      
      private const const_2039:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_675 = param1;
            this.var_61.initConnection(HabboConnectionType.const_288);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_83,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_61 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_61.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_61.addHabboConnectionMessageEvent(new HelloMessageEvent(this.onHelloEvent));
            this.var_61.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_61.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_61.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_61.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_61.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_61.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_61.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_61.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_61.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_61.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_61.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_61.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_61 && this.var_154 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_247 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         ...
         {
            this.var_247.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_154.getKey("use.sso.ticket") == "1";
         this.var_675 = this.var_154.getKey("sso.ticket",null);
         this.var_1963 = this.var_154.getKey("flash.client.url","");
         this.var_2630 = this.var_154.getKey("external.variables.txt","");
         if(this.var_247 == null)
         {
            this.var_247 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_61.mode = HabboConnectionType.const_95;
            if(this.var_675)
            {
               this.var_61.initConnection(HabboConnectionType.const_288);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_490,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1717);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_61.mode = HabboConnectionType.const_1335;
            }
         }
         this.var_61.initConnection(HabboConnectionType.const_288);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_61.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_858);
            _loc3_ = new InitCryptoMessageComposer(this.var_61.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2631 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_61.mode)
         {
            case HabboConnectionType.const_95:
               ...
               this.var_1572 = _loc4_;
               this.var_247.loadBannerImage(_loc7_ + "?token=" + this.var_1572,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1335:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1706:
               this.var_1030 = this.generateRandomHexString(30);
               this.var_564 = new DiffieHellman(new BigInteger(this.var_154.getKey("connection.development.prime"),16),new BigInteger(this.var_154.getKey("connection.development.generator"),16));
               this.var_564.init(this.var_1030);
               _loc8_ = this.var_564.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_61.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2631);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1571 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_264);
         connection.send(new VersionCheckMessageComposer(401,this.var_1963,this.var_2630));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2039,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_675 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_675);
            _loc2_.send(_loc4_);
      ...
      {
         var _loc4_:IConnection = this.var_61.getHabboMainConnection(null);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1571)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_205);
         }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1572);
         ...
         var _loc9_:IConnection = this.var_61.getHabboMainConnection(null);
