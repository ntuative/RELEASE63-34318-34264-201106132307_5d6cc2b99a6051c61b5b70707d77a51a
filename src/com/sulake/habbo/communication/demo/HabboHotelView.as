package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_923:IDesktopWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_1217:Function;
      
      private var var_1216:Function;
      
      private var var_806:IAssetLibrary;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_806 = param2;
         this._events = param3;
         this.var_923 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_806.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_806.getAssetByName(_loc2_.assetName);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_604));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_806.loadAssetFromFile("hotel_view_banner_" + this.var_1215,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_797));
            }
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_923.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_923.removeChild(this._window);
         }
      }
   }
}
