package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
            ...
            if(_loc3_.operation == RoomObjectOperationEnum.OBJECT_PLACE)
            {
               ...
               switch(_loc6_)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     this._roomEngine.method_2(param1,param2,_loc5_);
                     break;
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_718,param1,param2,param3,param4));
         }
      }
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_68:
               ...
               break;
            case RoomObjectStateChangeEvent.const_831:
            ...
            case RoomObjectFurnitureActionEvent.const_646:
            ...
            case RoomObjectFurnitureActionEvent.const_629:
            ...
            case RoomObjectFurnitureActionEvent.const_644:
            ...
            case RoomObjectRoomAdEvent.const_529:
            case RoomObjectRoomAdEvent.const_355:
            case RoomObjectRoomAdEvent.const_339:
            case RoomObjectRoomAdEvent.const_507:
               this.handleObjectRoomAdEvent(param1,param2,param3);
               break;
            case RoomObjectRoomActionEvent.const_585:
            case RoomObjectRoomActionEvent.const_1959:
            case RoomObjectRoomActionEvent.const_583:
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectMouseEvent.const_620:
               ...
               break;
            case RoomObjectMouseEvent.const_608:
               this.handleRoomObjectMouseDown(param1,param2,param3);
               break;
            case RoomObjectMouseEvent.const_182:
               this.handleRoomObjectMouseEnter(param1,param2,param3);
               break;
            case RoomObjectMouseEvent.const_194:
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc8_ == RoomObjectCategoryEnum.const_86)
         {
            ...
            if(_loc15_ != _loc10_ && _loc16_ != _loc10_)
            {
               ...
               if(_loc17_ != null)
               {
                  _loc17_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_496,param2,param3,-1,RoomObjectCategoryEnum.const_151));
               }
         ...
         if(this._roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_601);
               }
               else
               {
      ...
      private function handleRoomObjectMouseEnter(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_182,param2,param3,param1.objectId,this._roomEngine.getRoomObjectCategory(param1.objectType)));
         }
      }
      ...
      private function handleRoomObjectMouseLeave(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_194,param2,param3,param1.objectId,this._roomEngine.getRoomObjectCategory(param1.objectType)));
         }
      }
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_27 || _loc8_ == RoomObjectCategoryEnum.const_26)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_993,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function handleObjectPlace(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ == null)
         {
            ...
            if(_loc6_ != null)
            {
               if(_loc5_.category == RoomObjectCategoryEnum.const_27)
               {
                  ...
                  {
                     _loc9_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_721);
         ...
         if(_loc6_ != null)
         {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.const_26)
            {
               ...
               if(!_loc11_)
               {
                  this._roomEngine.method_2(param2,param3,_loc5_.id);
               }
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectFurnitureActionEvent.const_536:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_576:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_966,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_616:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_857,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_502:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_783,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_572:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_807,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_658:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1905,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_644:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1872,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_511:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_258,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc6_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_318);
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_389);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_389);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc8_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_318);
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_563);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_883);
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_323,param2);
         }
      }
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = this._roomEngine.getRoomObject(roomId,roomCategory,this.var_1664,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            ...
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_601));
            }
            else
            {
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_721);
         }
      ...
      private function placeObject(param1:int, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc7_ == RoomObjectCategoryEnum.const_29 && _loc5_.typeId == RoomObjectTypeEnum.const_222)
               {
                  this._roomEngine.connection.send(new PlacePetMessageComposer(_loc6_,int(_loc10_),int(_loc11_)));
               }
               else if(_loc8_.getModelController().getString(RoomObjectVariableEnum.const_1145) != null)
               {
         ...
         if(this._roomEngine && this._roomEngine.events)
         {
            ...
            this._roomEngine.events.dispatchEvent(new RoomEngineObjectPlacedEvent(RoomEngineObjectEvent.const_139,param1,param2,_loc6_,_loc7_,_loc9_,_loc10_,_loc11_,_loc12_,_loc13_,_loc17_,param3,param4,_loc5_.instanceData));
         }
      }
