   ...
   public class TileHeightMap
   {
      ...
      public function TileHeightMap(param1:int, param2:int)
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_1096.push(_loc5_);
            this.var_1347.push(_loc6_);
            _loc3_++;
         }
         this.var_185 = param1;
         this.var_184 = param2;
      ...
      {
         var _loc3_:* = null;
         if(param1 >= 0 && param1 < this.var_185 && param2 >= 0 && param2 < this.var_184)
         {
      ...
      public function isRoomTile(param1:int, param2:int) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_185 && param2 >= 0 && param2 < this.var_184)
         {
            _loc3_ = this.var_1347[param2] as Array;
            return Boolean(_loc3_[param1]);
         }
         return true;
      }
      ...
      public function setIsRoomTile(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(param1 >= 0 && param1 < this.var_185 && param2 >= 0 && param2 < this.var_184)
         {
            _loc4_ = this.var_1347[param2] as Array;
            _loc4_[param1] = param3;
            if(!param3)
            {
      ...
      public function validateLocation(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:int) : Boolean
      {
         ...
         if(param1 + param3 > this.var_185 || param2 + param4 > this.var_184)
         {
            return false;
         }
         if(param5 < 0 || param5 >= this.var_185)
         {
            param5 = 0;
         }
         ...
         if(param5 + param7 >= this.var_185)
         {
            param7 = this.var_185 - param5;
         }
         ...
         {
            _loc11_ = this.var_1096[_loc10_] as Array;
            _loc9_ = param1;
