package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_1220:PlaneVisualization = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_384 != null)
         {
            ...
            {
               _loc1_ = this.var_384.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = this.var_384.getWithIndex(_loc1_) as PlaneVisualization;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(this.var_384.getValue(String(param1)) != null)
         {
            return null;
         }
         var _loc4_:PlaneVisualization = new PlaneVisualization(param1,param2,param3);
         this.var_384.add(String(param1),_loc4_);
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            this.var_1220 = this.var_384.getValue(String(this._sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            this.var_1220 = null;
