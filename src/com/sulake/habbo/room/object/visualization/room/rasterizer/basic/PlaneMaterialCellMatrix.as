package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1890:int = const_409;
      ...
      private var var_1947:Boolean = true;
      
      private var var_2554:Number = -1.0;
      
      private var _normalMaxX:Number = 1.0;
      
      private var var_2555:Number = -1.0;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1.0, param5:Number = 1.0, param6:Number = -1.0, param7:Number = 1.0)
      {
         ...
         this.var_2555 = param6;
         this.var_2553 = param7;
         if(this.var_1946 == const_982)
         {
            this.var_1947 = false;
         }
      }
         ...
         if(this.isStatic)
         {
            if(this.var_33 != null)
            {
               if(this.var_33.width == param2 && this.var_33.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_669,param6,param7);
                     return param1;
                  }
                  return this.var_33;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         {
            _loc5_ = new Rectangle(0,0,this.var_33.width,this.var_669);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_33.height - this.var_669,this.var_33.width,this.var_669);
         }
