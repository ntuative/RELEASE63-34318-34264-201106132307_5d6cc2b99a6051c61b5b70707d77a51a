package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_2002:Boolean = true;
      ...
      private var var_761:PlaneMaskManager = null;
      ...
      private var var_471:PlaneBitmapData = null;
      ...
      {
         return this._isVisible && this.var_849;
      }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_471;
         if(_loc3_ == null)
         {
         ...
         if(this.var_849 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_402))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            _loc6_ = this.var_311.length * param1.scale;
            ...
            if(this.var_1051 != null)
            {
               _loc3_ = this.var_1051.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2002,this.var_2732,this.var_2730,this.var_2733,this.var_2734,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1696 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_849)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1531.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1531[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1139);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_167.z - originZ,this.var_123.z - originZ,this.var_95.z - originZ,this.var_124.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2246 = relativeDepth;
            this._isVisible = true;
            this.var_1696 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2731);
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_1052)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_403.length)
            {
               _loc5_ = this.var_403[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_283.length == this.var_1053.length)
         {
         ...
         if(this.var_403.length > this.var_1593.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1052 || this.var_283.length == 0 && this.var_403.length == 0 && !this.var_402 || this.var_761 == null)
         {
            return;
         }
         ...
         if(this.var_402)
         {
            ...
            while(_loc5_ < this.var_283.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc3_.leftSideLoc / this.var_310.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc3_.rightSideLoc / this.var_311.length;
                  _loc12_ = _loc3_.type;
                  this.var_761.updateMask(this.var_79,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_403.length)
            {
               _loc4_ = this.var_403[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc4_.leftSideLoc / this.var_310.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc4_.rightSideLoc / this.var_311.length;
                  _loc13_ = this.var_79.width * _loc4_.leftSideLength / this.var_310.length;
                  _loc14_ = this.var_79.height * _loc4_.rightSideLength / this.var_311.length;
                  this.var_79.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1593.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_402 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_250.copyChannel(param1,param1.rect,const_702,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_250.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_250,this.var_250.rect,const_702,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
