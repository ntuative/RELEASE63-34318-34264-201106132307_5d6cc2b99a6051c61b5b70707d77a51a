package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2105:int = 16777216;
      ...
      private var var_1991:int = 16777216;
      
      private var var_3034:int = 69069;
      ...
      {
         var _loc1_:int = this.var_3034 * this.var_1992 + this.var_3035;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1991;
         this.var_1992 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1991 * param2);
      }
   }
}
