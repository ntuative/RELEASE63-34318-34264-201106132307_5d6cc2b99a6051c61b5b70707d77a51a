package com.sulake.habbo.room.object.visualization.room.rasterizer.animated
{
   ...
   public class AnimationItem
   {
      ...
      private var var_176:Number = 0.0;
      
      private var var_1461:Number = 0.0;
      
      private var var_1462:Number = 0.0;
      ...
      public function AnimationItem(param1:Number, param2:Number, param3:Number, param4:Number, param5:BitmapData)
      {
         ...
         this.var_1462 = param4;
         if(isNaN(this._x))
         {
            this._x = 0;
         }
         if(isNaN(this.var_176))
         {
            this.var_176 = 0;
         }
         if(isNaN(this.var_1461))
         {
            this.var_1461 = 0;
         }
      ...
      public function getPosition(param1:int, param2:int, param3:Number, param4:Number, param5:int) : Point
      {
         ...
         var _loc7_:Number = this.var_176;
         if(param3 > 0)
         {
            _loc6_ += this.var_1461 / param3 * param5 / 1000;
         }
         if(param4 > 0)
         {
            _loc7_ += this.var_1462 / param4 * param5 / 1000;
         }
