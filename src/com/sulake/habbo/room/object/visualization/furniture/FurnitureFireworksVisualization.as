package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_657)
         {
            for each(_loc1_ in this.var_657)
            {
               _loc1_.dispose();
            }
            this.var_657 = null;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_243 = this.var_657[param1];
               _loc3_ = true;
            }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1140);
         if(_loc3_.length == 0)
         {
