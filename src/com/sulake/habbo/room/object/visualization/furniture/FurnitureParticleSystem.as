package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_285:IRoomObjectSprite;
      ...
      private var var_1289:Number = 1.0;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_1597 = new ColorTransform();
         this.var_2008 = new Matrix();
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_1288)
         {
            _loc1_.dispose();
         }
         this.var_1288 = null;
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_112 = this.var_1288[param1];
         this.var_1056 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_2007 >= 0)
         {
            this.var_285 = this._visualization.getSprite(this.var_2007);
            if(this.var_285 && this.var_285.asset)
            {
               if(this.var_285.width <= 1 || this.var_285.height <= 1)
               {
                  return;
               }
               if(this.var_98 == null)
               {
                  this.var_98 = this.var_285.asset.clone();
                  if(this.var_851.alphaMultiplier != 1)
                  {
                     this.var_685 = new BitmapData(this.var_98.width,this.var_98.height,true,4278190080);
                  }
               }
               this.var_2743 = -this.var_285.offsetX;
               this.var_2744 = -this.var_285.offsetY;
               this.var_285.asset = this.var_98;
            }
            if(this.var_98)
            {
            ...
            if(this.var_685)
            {
               this.var_685.fillRect(this.var_685.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_112.y * this.var_1289;
         }
         return 0;
      }
      ...
      {
         if(!this.var_112 || !this.var_285)
         {
            return;
         }
         if(this.var_98 && this.var_285.asset != this.var_98)
         {
            this.var_285.asset = this.var_98;
         }
         if(this.var_1056)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_1056 && this.var_112.hasIgnited)
         {
            this.var_1056 = true;
         }
         _loc8_ = this.var_1187 * this.var_1289;
         this.var_112.update();
         if(this.var_1056)
         {
            if(this.var_112.roomObjectSpriteId >= 0)
            ...
            {
               this.var_98.draw(this.var_685,this.var_2008,this.var_851,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_112.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2743 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1289;
               _loc4_ = this.var_2744 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1289;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1597.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_98.draw(_loc7_,this._translationMatrix,this.var_1597,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         this.var_2007 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_1187 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1289 = this.var_2745 / 64;
         ...
         for each(_loc3_ in param1.emitter)
         {
            ...
            for each(_loc23_ in _loc3_.particles.particle)
            {
               ...
               _loc19_ = _loc23_.@is_emitter == "PresentHandler" ? false : true;
