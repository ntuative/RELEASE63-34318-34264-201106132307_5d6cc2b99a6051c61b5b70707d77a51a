package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc3_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_318);
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_389);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_563);
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         this.method_13(param1,param2);
      }
      
      protected function method_13(param1:IRoomGeometry, param2:int) : void
      {
         ...
         while(_loc5_ < this.var_161.length)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + this.var_1370;
               }
