package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1653:uint = 16777215;
      
      private var var_2128:int = 255;
      
      private var var_1360:uint = 16777215;
      
      private var var_2127:int = 255;
      
      private var var_1359:int = 0;
      
      private var var_2126:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_620,RoomObjectMouseEvent.const_165];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1215,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_885,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_960,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_891,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1359)
         {
            ...
            if(_loc2_ - this.var_1359 >= this.var_2126)
            {
               _loc3_ = this.var_1360;
               _loc4_ = this.var_2127;
               this.var_1359 = 0;
            }
            else
            {
               _loc7_ = this.var_1653 >> 16 & 255;
               _loc8_ = this.var_1653 >> 8 & 255;
               _loc9_ = this.var_1653 & 255;
               _loc10_ = this.var_1360 >> 16 & 255;
               _loc11_ = this.var_1360 >> 8 & 255;
               _loc12_ = this.var_1360 & 255;
               _loc13_ = (_loc2_ - this.var_1359) / this.var_2126;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2128 + (this.var_2127 - this.var_2128) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_885,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_729:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_1002:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_533:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_251)
               {
                  _loc5_ = "null";
               }
               this.var_591.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_752:
               _loc4_ = this.var_591.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_591.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1266,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1199:
               param2.setNumber(RoomObjectVariableEnum.const_960,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1378:
               param2.setNumber(RoomObjectVariableEnum.const_891,_loc3_);
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_680:
               param2.setNumber(RoomObjectVariableEnum.const_1331,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1159:
               param2.setNumber(RoomObjectVariableEnum.const_1268,param1.value);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1365,int(param1.bgOnly));
         this.var_1653 = this._color;
         this.var_2128 = this.var_1843;
         this.var_1360 = _loc3_;
         this.var_2127 = _loc4_;
         this.var_1359 = getTimer();
         this.var_2126 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_611,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1885,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1710,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1760,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_611,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_293 || _loc12_ == RoomPlaneData.const_388)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
