package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_576,RoomObjectFurnitureActionEvent.const_616,RoomObjectFurnitureActionEvent.const_502,RoomObjectFurnitureActionEvent.const_536];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_2408)
         {
            this.var_2408 = _loc3_;
            if(_loc3_ == 1)
            {
