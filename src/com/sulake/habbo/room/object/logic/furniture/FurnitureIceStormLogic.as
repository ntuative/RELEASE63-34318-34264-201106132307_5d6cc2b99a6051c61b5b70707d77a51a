package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private var var_2899:Number = 0.0;
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_2093 = _loc2_;
            this.var_2899 = param1.extra;
            this.var_1346 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1346 > 0 && param1 >= this.var_1346)
         {
            this.var_1346 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_2093,String(this.var_2093),this.var_2899);
