package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_165,RoomObjectMoveEvent.const_447];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2532)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1488 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_240,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_426,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1836,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_975,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_206,_loc3_ + this.var_991);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1904;
            _loc2_.setNumber(RoomObjectVariableEnum.const_300,this.var_1904);
            _loc2_.setNumber(RoomObjectVariableEnum.const_161,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1903;
            _loc2_.setNumber(RoomObjectVariableEnum.const_161,this.var_1903);
         }
         else
         {
            this.var_991 += 45;
