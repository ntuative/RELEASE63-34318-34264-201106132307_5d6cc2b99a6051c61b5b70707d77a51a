package com.sulake.habbo.session.handler
{
   ...
   public class RoomDimmerPresetsHandler extends BaseHandler
   {
      ...
      private function onRoomDimmerPresets(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:RoomSessionDimmerPresetsEvent = new RoomSessionDimmerPresetsEvent(RoomSessionDimmerPresetsEvent.const_481,_loc6_);
         ...
         while(_loc8_ < _loc3_.presetCount)
         {
            ...
            if(_loc9_ != null)
            {
               _loc7_.method_3(_loc9_.id,_loc9_.type,_loc9_.color,_loc9_.light);
            }
            _loc8_++;
         }
         if(listener && false)
