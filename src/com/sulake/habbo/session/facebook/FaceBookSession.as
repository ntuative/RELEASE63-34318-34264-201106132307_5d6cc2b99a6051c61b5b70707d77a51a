package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1045:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1472:String = "sendAccessTokenToServer";
      
      private static const const_1471:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1472,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1471,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1045);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1045);
         }
      }
