package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1411:Point = new Point(3,3);
      
      private static const const_1649:uint = 7433577;
      
      private static const const_1650:uint = 5723213;
      
      private static const const_477:String = "_hover";
      
      private static const const_476:String = "_normal";
      
      private static const const_478:int = 5;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1411;
         ...
         this.var_341 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_341);
         var _loc14_:ITextWindow = this.var_341.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_341.x = _loc13_.width - this.var_341.width - const_478;
         this.var_341.y = const_478;
         this.var_2885 = this.isNewItemsNotificationEnabled();
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_341 != null && this.var_2885)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_799:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_970:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_477);
               this.setIconBgHoverState(_loc3_,const_477);
               break;
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_477 ? this.var_1642 : this.var_1641;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_477)
         {
            param1.color = const_1649;
         }
         else
         {
            param1.color = const_1650;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1641 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1642)
         {
            this.var_1642.dispose();
         }
         this.var_1642 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1092.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_478;
            _loc2_.y = const_478;
            this.var_1092.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      {
         return this._config.getKey("toolbar.new_additions.notification.enabled","PresentHandler") == "true";
      }
   }
}
