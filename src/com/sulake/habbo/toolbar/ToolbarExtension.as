package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1654:uint = 16777215;
      
      private static const const_1656:uint = 12247545;
      
      private static const const_1655:String = "HELP";
      
      private static const const_1653:String = "ROOMINFO";
      ...
      private var var_370:IWindow;
      
      private var var_710:IWindowContainer;
      
      private const const_778:int = 41;
      ...
      public function ToolbarExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_370 = this._window.findChildByName("roominfo_region");
         this.var_66 = this._window.findChildByName("list") as IItemListWindow;
         var _loc7_:* = [];
         this.var_66.groupListItemsWithTag("REGION",_loc7_);
      ...
      {
         this.var_66.removeListItem(this.var_370);
      }
      
      public function showRoomInfo() : void
      {
         this.var_66.addListItemAt(this.var_370,0);
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_710)
         {
            this.var_710 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1655);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1653);
               break;
            case "confirm":
               if(false)
               {
