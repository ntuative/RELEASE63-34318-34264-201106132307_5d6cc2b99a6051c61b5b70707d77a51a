package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1128:Boolean = false;
      
      private static const const_709:String = "Navigation";
      
      private static const const_710:String = "Friend Bar";
      
      private static const const_1667:String = "go.friendbar";
      
      private static const const_1665:String = "chat_btn_click";
      
      private static const const_1668:String = "find_friends_btn_click";
      
      private static const const_1125:String = "Toolbar";
      
      private static const const_1127:String = "open";
      
      private static const const_1126:String = "close";
      
      private static const const_1666:String = "FRIENDLIST";
      
      private static const const_1669:String = "MESSENGER";
      ...
      private var var_120:IHabboFriendList;
      
      private var var_229:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_120)
            {
               this.var_120.release(new IIDHabboFriendList());
               this.var_120 = null;
            }
            if(this.var_229)
            {
               this.var_229.release(new IIDHabboMessenger());
               this.var_229 = null;
            }
            this.var_113 = null;
      ...
      {
         return this.var_343.getValue(param1);
      }
      ...
      public function acceptFriendRequest(param1:int) : void
      {
         ...
         if(this.var_120)
         {
            ...
            {
               this.var_120.acceptFriendRequest(param1);
            }
         }
      }
      ...
      {
         this.var_121 = null;
         this.var_120.acceptAllFriendRequests();
      ...
      public function declineFriendRequest(param1:int) : void
      {
         ...
         if(this.var_120)
         {
            if(!this.var_120.disposed)
            {
               this.var_120.declineFriendRequest(param1);
            }
         }
      }
      ...
      {
         this.var_121 = null;
         this.var_120.declineAllFriendRequests();
         events.dispatchEvent(new FriendRequestEvent());
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_709,const_710,const_1667));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_229)
         {
            this.var_229.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_93)
            {
               this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_709,const_710,const_1665));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_709,const_710,const_1668));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_120)
         {
            if(!this.var_120.disposed)
            {
               if(!this.var_120.isOpen())
               {
                  if(this.var_121.length > 0)
                  {
                     this.var_120.openFriendRequests();
                  }
                  else
                  {
                     this.var_120.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_120.mainWindow;
               ...
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1125,const_1666,!!this.var_120.isOpen() ? const_1127 : const_1126));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_229)
         {
            ...
            {
               this.var_229.toggleMessenger();
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1125,const_1669,!!this.var_229.isOpen() ? const_1127 : const_1126));
               }
            }
         }
      }
      ...
      {
         this.var_1104 = param2 as IHabboConfigurationManager;
         this.var_2938 = this.var_1104.getBoolean("friendbar.notifications.enabled",false);
         this.var_2129 = this.var_1104.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_343.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_343.remove(_loc8_);
               this.var_113.splice(this.var_113.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_343.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_313)
            {
               ...
               this.var_343.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_313)
            {
               if(this.var_343.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_897 = _loc2_.senderId;
         var _loc3_:Boolean = true;
         if(this.var_229)
         {
            if(this.var_229.isOpen())
            {
               _loc4_ = this.var_229.getActiveConversation();
               if(_loc4_)
               {
                  if(_loc4_.id == this.var_897)
                  {
                     _loc3_ = false;
                  }
               }
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_897));
            this.makeNotification(String(this.var_897),FriendNotification.const_401,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_897 = _loc2_.senderId;
         if(this.var_229 && !this.var_229.isOpen())
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_897));
            this.makeNotification(String(this.var_897),FriendNotification.const_401,null,true,false);
         }
      }
