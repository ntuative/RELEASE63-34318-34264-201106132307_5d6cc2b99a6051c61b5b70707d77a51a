package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1411:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1985:FriendListTabsView;
      ...
      private var var_1586:ITextWindow;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1985 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1411;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1033 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_302 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1985.prepare(this.var_1033);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1353,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1316,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_992,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_952,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_992,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_952,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1586 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1586.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1987 == -1 ? 0 : int(this.var_17.height - this.var_1987);
         var _loc4_:int = this.var_1984 == -1 ? 0 : int(this.var_17.width - this.var_1984);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_302.y = Util.getLowestPoint(this.var_17.content);
         this.var_302.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1201,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_992,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1353,false);
         ...
         this.var_1987 = this.var_17.height;
         this.var_1984 = this.var_17.width;
