package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         this.var_899 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_899.procedure = this.onSearchInput;
         this.var_899.addEventListener(WindowKeyboardEvent.const_210,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_66.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_404,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         var _loc10_:IWindowContainer = this.var_66.getListItemAt(param2) as IWindowContainer;
         if(_loc10_ == null)
         {
            if(!param1)
            {
            ...
            this.var_66.addListItem(_loc10_);
         }
         if(param1)
         {
            _loc10_.height = 20;
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_604.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_604.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function findIndexFor(param1:int) : int
      {
         ...
         {
            if(this.var_66.getListItemAt(_loc2_).id == param1)
            {
               return _loc2_;
            }
            _loc2_++;
