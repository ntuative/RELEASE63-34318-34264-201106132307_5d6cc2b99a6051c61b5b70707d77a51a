package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_450:int = 100;
      ...
      {
         var _loc4_:* = null;
         if(this.var_256.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         while(_loc3_ < this.var_256.length)
         {
            ...
            {
               this.var_256.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean = false) : int
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         for each(_loc4_ in this.var_256)
         {
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_256,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         if(this.var_1101 >= this.getPageCount())
         {
            this.var_1101 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_256.length / const_450);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_1101 * const_450;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_1101 + 1) * const_450,this.var_256.length);
      }
