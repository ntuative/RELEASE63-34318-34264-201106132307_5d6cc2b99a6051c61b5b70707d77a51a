package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_189:String = "face";
      ...
      private var var_156:IHabboMessenger;
      ...
      private var var_798:ISessionDataManager;
      
      private var var_2451:FriendListLookAndFeel;
      
      private var var_463:FriendListTabs;
      ...
      var var_114:FriendCategories;
      
      private var var_121:FriendRequests;
      
      private var var_1824:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_1060:IHabboNotifications;
      
      private var var_647:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2451 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_114 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1824 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_647.stop();
            this.var_647.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_647 = null;
         }
         ...
         if(this.var_156)
         {
            this.var_156.release(new IIDHabboMessenger());
            this.var_156 = null;
         }
         if(this.var_169)
         {
         ...
         if(this.var_1060)
         {
            this.var_1060.release(new IIDHabboNotifications());
            this.var_1060 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_798)
         {
            this.var_798.release(new IIDSessionDataManager());
            this.var_798 = null;
         }
         super.dispose();
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_114.findFriend(param1);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_114.getFriendCount(param1,param2);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_357,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_793.createAvatarImage(param1,AvatarScaleType.const_114,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_169.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_169.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_156 = param2 as IHabboMessenger;
      ...
      {
         this.var_1060 = param2 as IHabboNotifications;
      ...
      {
         this.var_798 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_114.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_114.addCategory(new FriendCategory(FriendCategory.const_1216,this.getText("friendlist.friends")));
         this.var_114.addCategory(new FriendCategory(FriendCategory.const_422,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_114.addFriend(new Friend(_loc4_));
         }
         this.var_463 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_647)
         {
            this.var_647 = new Timer(120000);
            this.var_647.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_647.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         if(this.var_114.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_114.findCategory(FriendCategory.const_422);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_463.findTab(FriendListTab.const_93).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_463.findTab(FriendListTab.const_93);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1824.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_114.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_114.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_463.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_463.findTab(FriendListTab.const_93);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_798 || !this.var_121)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_798.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this.var_121.vipLimit;
         }
         else if(this.var_798.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_38))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(disposed || this.var_114 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_114.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_189) as IBitmapWrapperWindow;
