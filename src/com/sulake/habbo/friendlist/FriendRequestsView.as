package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2028:String = "no_reqs_info";
      ...
      private var var_1783:IContainerButtonWindow;
      ...
      {
         this.var_1783 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1784 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1784.procedure = this.onDismissAllButtonClick;
         this.var_1783.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         this.var_66.addListItem(param1.view);
         this._friendList.friendRequests.refreshShading();
         this.refreshButtons();
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         this.var_66.removeListItem(param1.view);
         this.refreshButtons();
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_398;
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_398 && _loc2_.state != FriendRequest.const_395)
            {
               ...
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_62,_loc2_.requestId));
               }
            }
         }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_395;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_367,param1));
         }
      }
      ...
      public function declineAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_398 && _loc2_.state != FriendRequest.const_395)
            {
               ...
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_367,_loc2_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1783,_loc1_);
         this.setEnabled(this.var_1784,_loc1_);
      }
