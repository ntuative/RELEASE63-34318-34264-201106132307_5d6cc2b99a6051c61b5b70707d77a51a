package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2149:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2798:IContainerButtonWindow;
      
      private var var_2797:IContainerButtonWindow;
      
      private var var_2795:IContainerButtonWindow;
      
      private var var_2796:IContainerButtonWindow;
      
      private var var_66:IItemListWindow;
      
      private var var_604:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_604 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2798 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2797 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2795 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2796 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = this.var_66.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
            ...
            this.var_66.addListItem(_loc6_);
         }
      ...
      private function refreshFigure(param1:IWindowContainer, param2:Friend) : void
      {
         ...
         var _loc3_:IBitmapWrapperWindow = param1.getChildByName(HabboFriendList.const_189) as IBitmapWrapperWindow;
         if(!_loc3_)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2798,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2797,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2795,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2796,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_604.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_604.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_604.closePopup();
         }
