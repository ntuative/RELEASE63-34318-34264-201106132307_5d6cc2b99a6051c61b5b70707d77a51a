package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2293:int = 5;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_799.length)
         {
            if(this.var_799[_loc2_] == param1)
            {
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1205.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_651.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_365.getBadgeImage(param1);
            if(_loc10_)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_321);
         var _loc3_:int = 0;
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_520);
         ...
         var _loc3_:Array = this.getBadges(const_321);
      ...
      {
         return this.getItemInIndex(param1,const_321);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_520);
      }
      ...
      {
         if(param1 == InventoryCategory.const_268 && this.var_29.isVisible)
         {
            this.var_29.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_BADGES));
         }
      }
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_651.indexOf(_loc2_) == -1)
            {
               this.var_651.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_651 && this.var_651.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1179));
            this.var_651 = [];
            for each(_loc2_ in this.var_238)
            {
               _loc2_.method_4 = false;
            }
            this.updateView();
