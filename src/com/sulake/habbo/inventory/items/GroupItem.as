package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1512:int = 13421772;
      
      private static const const_1511:int = 10275685;
      ...
      private var var_2454:IWindow;
      
      protected var _roomEngine:IRoomEngine;
      
      protected var var_1014:Boolean;
      ...
      protected var var_2224:String;
      
      protected var var_1616:Number;
      
      protected var var_919:int = 0;
      
      protected var var_737:BitmapData;
      
      protected var include:int;
      
      protected var var_1684:Boolean;
      
      protected var var_2223:Boolean;
      
      protected var var_3010:BitmapData;
      
      private var var_1643:Boolean;
      
      private const const_2055:Number = 1;
      
      private const const_2056:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2454 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2222 == FurniModelCategory.const_36)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1616));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2224);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_813)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2056;
               _loc1_.blend = this.const_2056;
            }
            else
            {
               this._window.blend = this.const_2055;
               _loc1_.blend = this.const_2055;
            }
         }
         this.var_1511.color = !!this.var_1643 ? uint(const_1511) : uint(const_1512);
         this.var_2454.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2223 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3010;
               _loc5_.visible = true;
            }
            else
            {
