package com.sulake.habbo.inventory.items
{
   public class FloorItem implements IItem
   {
      ...
      protected var var_3008:Boolean;
      
      protected var var_2755:Boolean;
      
      protected var var_2825:Boolean;
      
      protected var var_3007:int;
      
      protected var var_2753:int;
      
      protected var var_2752:int;
      
      protected var var_2756:int;
      
      protected var var_1972:String;
      
      protected var var_1799:int;
      ...
      public function FloorItem(param1:int, param2:int, param3:int, param4:int, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean, param9:String, param10:Number, param11:int, param12:int, param13:int, param14:int, param15:String, param16:int)
      {
         ...
         this.var_3008 = param6;
         this.var_3009 = param7;
         this.var_2825 = param8;
         this.var_2224 = param9;
         this.var_1616 = param10;
         this.var_3007 = param11;
         this.var_2753 = param12;
         this.var_2752 = param13;
         this.var_2756 = param14;
         this.var_1972 = param15;
         this.var_1799 = param16;
      }
