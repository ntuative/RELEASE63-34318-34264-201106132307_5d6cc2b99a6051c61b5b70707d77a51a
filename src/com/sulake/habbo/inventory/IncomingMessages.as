package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         this.var_13 = param1;
         this.var_28 = this.var_13.communication;
         ...
         this.var_28.addHabboConnectionMessageEvent(new AchievementsEvent(this.onAchievements));
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_71,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.EFFECTS);
         _loc2_.refreshViews();
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_268);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this.var_13.toggleInventorySubPage(InventorySubCategory.const_356);
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_213)
            {
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_417);
      ...
      {
         var _loc2_:* = null;
         if(this.var_13.isInventoryCategoryInit(InventoryCategory.const_417))
         {
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this.var_13.furniModel.addUnseenFloorItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_390));
         this.var_13.furniModel.addUnseenWallItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_397));
         this.var_13.petsModel.addUnseenPets(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_58));
         this.var_13.badgesModel.addUnseenBadges(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_1179));
