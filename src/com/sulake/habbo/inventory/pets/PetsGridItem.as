package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_44:
               this.var_1512.setSelectedGridItem(this);
               this.var_1510 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1510 = false;
                  this.var_1512.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1511)
         {
            return;
         }
         this.var_1511.color = !!this.var_1604 ? uint(const_1511) : uint(const_1512);
         this.var_2454.visible = param1;
      }
