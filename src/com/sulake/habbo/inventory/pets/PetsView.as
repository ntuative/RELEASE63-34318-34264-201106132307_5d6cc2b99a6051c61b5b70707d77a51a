package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1064:int = 1;
      
      private const const_1104:int = 2;
      ...
      private var var_76:PetsModel;
      
      private var _disposed:Boolean = false;
      
      private var var_221:IItemGridWindow;
      ...
      private var var_233:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_221 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_233);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_567.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_221.removeGridItem(_loc2_.window);
         if(this.var_233 == _loc2_)
         {
            this.var_233 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_567 == null || this.var_567.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_567.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_567.getValue(param1.id) != null)
         {
            return;
         }
         var _loc2_:PetsGridItem = new PetsGridItem(this,param1,this._windowManager,this._assetLibrary,this._avatarRenderer,this.var_76.method_4(param1.id));
         if(_loc2_ != null)
         {
            this.var_221.addGridItem(_loc2_.window);
            this.var_567.add(param1.id,_loc2_);
      ...
      private function updateGrid() : void
      {
         ...
         this.var_221.removeGridItems();
         for each(_loc1_ in this.var_567)
         {
            _loc1_.dispose();
         }
         this.var_567.reset();
         _loc2_ = this.var_76.pets;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_233.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         this.var_76.placePetToRoom(param1,param2);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_48)
         {
            ...
            {
               case "tab_floor":
                  this.var_76.switchToFurnitureCategory(FurniModelCategory.const_36);
                  break;
               case "tab_wall":
                  this.var_76.switchToFurnitureCategory(FurniModelCategory.const_45);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_233 != null)
         {
            this.var_233.setSelected(false);
         }
         this.var_233 = param1;
         if(this.var_233 != null)
         {
            this.var_233.setSelected(true);
         }
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Map = this.var_76.pets;
         if(!this.var_76.isListInitialized())
         {
            _loc2_ = this.const_1064;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1104;
         }
         else
         {
            _loc2_ = this.const_1105;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1064:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1104:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1105:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
               _loc6_.visible = true;
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(this.var_76.roomSession != null)
         {
            _loc8_ = this.var_76.roomSession.arePetsAllowed;
            _loc9_ = this.var_76.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_76.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_390) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_76.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_397) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_pets");
         _loc1_.visible = this.var_76.getUnseenItemCount() > 0;
      }
   }
}
