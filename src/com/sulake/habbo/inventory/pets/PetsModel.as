package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_137 && this.var_29.isVisible)
         {
            this._view.updateCategoryButtons();
            this.var_29.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_PETS));
         }
      }
      
      public function switchToFurnitureCategory(param1:String, param2:Boolean = false) : void
      {
         var _loc3_:FurniModel = this.var_29.furniModel;
         if(_loc3_ != null)
         {
            _loc3_.switchCategory(param1);
            this.var_29.toggleInventoryPage(InventoryCategory.const_71,param2);
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         if(this.var_29.roomSession.isRoomOwner)
         {
            this.var_1729 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_29,RoomObjectTypeEnum.const_222,_loc3_.figureString);
            this.var_29.closeView();
            return;
         }
         if(!this.var_29.roomSession.arePetsAllowed)
         {
            return;
         }
         if(!param2)
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1729 && param1.type == RoomEngineObjectEvent.const_139)
         {
      ...
      {
         return this.var_29.roomSession;
      }
      ...
      public function addUnseenPets(param1:Array) : void
      {
         ...
         {
            if(this.var_520.indexOf(_loc2_) == -1)
            {
               this.var_520.push(_loc2_);
            }
         }
         this._view.update();
      }
      ...
      {
         if(!this.var_29.isMainViewActive)
         {
            return;
         }
         var _loc1_:IConnection = this._communication.getHabboMainConnection(null);
         if(this.var_520 && this.var_520.length > 0)
         {
      ...
      {
         return this.var_520.indexOf(param1) > -1;
      }
   }
}
