package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1577:int = 100;
      
      private static const const_1578:int = 1000;
      ...
      private var var_1565:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_466 = [];
         this.var_467 = [];
         this.var_673 = new Timer(const_1577,1);
         this.var_673.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2628 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_139,this.onObjectPlaced);
               }
            ...
            {
               this.var_673.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_673.stop();
               this.var_673 = null;
            }
            if(this.var_222 != null)
            {
               this.var_222.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_222.stop();
               this.var_222 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_36)
            {
               ...
               {
                  this.var_1565 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1565;
            }
            else
            {
         ...
         this.var_29.setInventoryCategoryInit(InventoryCategory.const_71);
         ...
         for each(_loc6_ in param2)
         {
            if(_loc9_.indexOf(_loc6_.stripId) > -1)
            {
               ...
               this.var_29.events.dispatchEvent(_loc19_);
            }
         }
      }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_334)
         {
         ...
         if(this.var_828 == null)
         {
            this.var_828 = this._windowManager.buildFromXML(this.var_2628) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_828.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_828.clone() as IWindowContainer;
         return new GroupItem(param1,param2,param3,_loc11_,this._roomEngine,_loc9_.clone(),this.var_29.recyclerModel.running,param4,param5,_loc7_,param6);
      }
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_222 = new Timer(param1,1);
            this.var_222.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_222.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_71 && this.var_29.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               case const_36:
                  this.var_29.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI));
                  break;
               case const_45:
                  this.var_29.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS));
                  break;
               case const_299:
                  this.var_29.toggleInventoryPage(InventoryCategory.const_137);
            }
         }
      }
      ...
      {
         this.var_29.checkCategoryInitilization(InventoryCategory.const_417);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc2_:TradingModel = this.var_29.tradingModel;
         if(_loc2_ != null)
         {
            _loc1_ = _loc1_.concat(_loc2_.getOwnItemIdsInTrade());
         }
         var _loc3_:RecyclerModel = this.var_29.recyclerModel;
         if(_loc3_ != null)
         {
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_672.add(const_36,new Array());
         this.var_672.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_36;
            _loc5_ = this.var_466.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_45;
            _loc5_ = this.var_467.indexOf(param1.ref) > -1;
         }
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_213)
                  {
                     _loc7_ = _loc9_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_299)
            {
               ...
               {
                  this.var_29.petsModel.switchToFurnitureCategory(_loc6_,true);
               }
            }
            else
            {
      ...
      {
         return getTimer() < this.var_2627 + const_1578;
      }
      ...
      {
         return this.var_29.getSubCategoryViewId() == InventorySubCategory.const_356;
      }
      
      public function canUserOfferToTrade() : Boolean
      {
         return this.var_29.canUserOfferToTrade();
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_351 || _loc3_.category == FurniCategory.const_334 || _loc3_.category == FurniCategory.const_328)
         {
            if(param1)
            {
               return false;
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(_loc3_)
         {
            this.var_1564 = param1.ref;
            if(!this.var_29.recyclerModel.running)
            {
               this.requestClose();
            }
            this.var_1156 = true;
      ...
      public function requestSelectedFurniToTrading() : void
      {
         ...
         var _loc3_:TradingModel = this.var_29.tradingModel;
         if(_loc3_ != null)
         {
      ...
      public function requestSelectedFurniSelling() : void
      {
         ...
         var _loc3_:MarketplaceModel = this.var_29.marketplaceModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_672.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_813)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      {
         if(!this.var_29 || !this.var_29.roomSession)
         {
            return false;
         }
         return this.var_29.roomSession.isPrivateRoom;
      }
      
      public function isMainViewActive() : Boolean
      {
         return this.var_29.isMainViewActive;
      }
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_466.indexOf(_loc2_) == -1)
            {
               this.var_466.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_467.indexOf(_loc2_) == -1)
            {
               this.var_467.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_390:
               return this.var_466.length;
            case UnseenItemCategoryEnum.const_397:
               return this.var_467.length;
            default:
               return this.var_466.length + this.var_467.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_45:
               if(this.var_467 && this.var_467.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_397));
                  this.var_467 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
               break;
            case const_36:
               if(this.var_466 && this.var_466.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_390));
                  this.var_466 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
         if(_loc3_)
         {
            this.var_29.updateUnseenItemCounts();
            for each(_loc4_ in _loc3_)
            {
