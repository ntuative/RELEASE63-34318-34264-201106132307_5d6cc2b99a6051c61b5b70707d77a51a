package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_2050:int = 0;
      
      private static const const_1064:int = 1;
      
      private static const const_1104:int = 2;
      
      private static const const_1105:int = 3;
      
      private static const const_1103:int = 42;
      
      private static const const_1106:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_409.add(FurniModelCategory.const_36,new FurniGridView(this.var_76,FurniModelCategory.const_36,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_409.add(FurniModelCategory.const_45,new FurniGridView(this.var_76,FurniModelCategory.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1088;
            _loc3_.y = _loc4_.y + const_1088;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         var _loc1_:Boolean = this.var_76.isTradingOpen;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_409.getValue(this.var_484);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_76.getCategoryContent(this.var_484);
         if(!this.var_76.isListInited())
         {
            _loc2_ = const_1064;
         }
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_409.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_409.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_409.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_409.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_76.getUnseenItemCount(UnseenItemCategoryEnum.const_390) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_76.getUnseenItemCount(UnseenItemCategoryEnum.const_397) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_pets");
         _loc1_.visible = this.var_76.petsModel.getUnseenItemCount() > 0;
      }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:int = this.var_76.getSelectedItemIndex();
         _loc4_ = this.var_76.getGroupItemInIndex(_loc3_,this.var_484);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_215);
            ...
            if(_loc5_.category == FurniCategory.const_334)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_213)
               {
         ...
         var _loc12_:Boolean = this.var_76.isTradingOpen;
         _loc11_ = this._view.findChildByName("placeinroom_btn") as IButtonWindow;
         if(_loc11_)
         {
            if(_loc1_ && this.var_76.isPrivateRoom)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc11_)
         {
            if(_loc1_ && _loc4_ != null && _loc5_ != null && this.var_76.canUserOfferToTrade())
            {
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1240)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1106)
         {
            _loc3_ = const_1106;
         }
         else if(_loc3_ < const_1103)
         {
            _loc3_ = const_1103;
         }
         else
      ...
      {
         var _loc3_:GroupItem = this.var_76.getGroupItemInIndex(this.var_76.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "placeinroom_btn":
                  this.var_76.requestSelectedFurniPlacement(false);
                  break;
               case "offertotrade_btn":
                  this.var_76.requestSelectedFurniToTrading();
                  break;
               case "sell_btn":
                  this.var_76.requestSelectedFurniSelling();
                  break;
               case "open_catalog_btn":
                  this.var_76.requestCatalogOpen();
                  break;
               default:
                  this.var_76.cancelFurniInMover();
            }
         }
