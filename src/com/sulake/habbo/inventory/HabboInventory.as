package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2309:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_57)
         {
            _loc1_ = this.var_57.getKeys();
            _loc2_ = 0;
            while(_loc2_ < _loc1_.length)
            {
               _loc3_ = _loc1_[_loc2_];
               _loc4_ = this.var_57.getValue(_loc3_) as IInventoryModel;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionEvent.const_83,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_535,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_57.getValue(InventoryCategory.const_71));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_57.getValue(InventorySubCategory.const_356));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_57.getValue(InventoryCategory.EFFECTS));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_57.getValue(InventoryCategory.const_268));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_57.getValue(InventoryCategory.ACHIEVEMENTS));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_57.getValue(InventorySubCategory.const_1267));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_57.getValue(InventoryCategory.const_137));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_57.getValue(InventoryCategory.const_417) as MarketplaceModel;
      }
      ...
      {
         this.var_365 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_83,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_535,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_83:
               this.var_1158 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_535:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_365 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_57.add(InventoryCategory.const_417,_loc1_);
         ...
         this.var_57.add(InventoryCategory.const_71,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_365);
         this.var_57.add(InventoryCategory.const_268,_loc3_);
         ...
         this.var_57.add(InventoryCategory.EFFECTS,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_365);
         this.var_57.add(InventoryCategory.ACHIEVEMENTS,_loc5_);
         ...
         this.var_57.add(InventorySubCategory.const_356,_loc6_);
         ...
         this.var_57.add(InventorySubCategory.const_1267,_loc7_);
         ...
         this.var_57.add(InventoryCategory.const_137,_loc8_);
      ...
      {
         var _loc2_:IInventoryModel = IInventoryModel(this.var_57.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_57.length)
         {
            _loc3_ = this.var_57.getWithIndex(_loc2_) as IInventoryModel;
         ...
         switch(param1)
         {
            case InventorySubCategory.const_356:
               this._view.toggleCategoryView(InventoryCategory.const_71,false);
         }
      }
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = this.var_57.getWithIndex(_loc1_) as IInventoryModel;
      ...
      {
         var _loc2_:IInventoryModel = this.var_57.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2309);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_271));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2770)
         {
            this.var_2770 = _loc1_;
