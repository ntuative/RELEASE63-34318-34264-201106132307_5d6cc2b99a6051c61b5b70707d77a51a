package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_584:RoomPopupCtrl;
      
      private var var_595:IScrollbarWindow;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_584 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_595 = IScrollbarWindow(this.var_200.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_595.scrollV = 0;
         }
         this.var_200.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getVisibleEntryCount() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_66.numListItems)
         {
            if(this.var_66.getListItemAt(_loc2_).visible)
            {
               _loc1_++;
            }
            _loc2_++;
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_185,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1825,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_228,null,0);
         this._navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_122,null,0);
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_584.visible && this.var_2912)
         {
            return;
         }
         ...
         this.var_584.room = _loc4_;
         this.var_584.showPopup(_loc2_);
      }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2911 - _loc2_.stageX);
         this.var_2911 = _loc2_.stageX;
         this.var_2912 = _loc3_ > 2;
      }
   }
}
