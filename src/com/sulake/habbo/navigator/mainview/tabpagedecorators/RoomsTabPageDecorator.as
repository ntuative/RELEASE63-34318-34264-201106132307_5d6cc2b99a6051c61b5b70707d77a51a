   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_160 == null)
         {
            ...
            this.var_160.addEventListener(WindowEvent.const_48,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_160 != null)
         {
            this.var_160.removeEventListener(WindowEvent.const_48,this.onFilterSelected);
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_221,Tabs.const_438);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_221,Tabs.const_1011);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_221,Tabs.const_438,"" + _loc3_);
         }
         if(this.var_160)
         {
