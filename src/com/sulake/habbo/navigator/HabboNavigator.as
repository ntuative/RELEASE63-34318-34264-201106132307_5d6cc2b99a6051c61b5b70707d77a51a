package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_334:MainViewCtrl;
      
      private var var_701:RoomInfoViewCtrl;
      
      private var var_1319:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_463:Tabs;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_334 = new MainViewCtrl(this);
         this.var_701 = new RoomInfoViewCtrl(this);
         this.var_1319 = new RoomCreateViewCtrl(this);
         this.var_2776 = new RoomThumbnailRenderer(this);
         this.var_1029 = new GuestRoomPasswordInput(this);
         this.var_317 = new GuestRoomDoorbell(this);
         this.var_463 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_357,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_334.onNavigatorToolBarIconClick();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_169.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_334.startSearch(Tabs.const_214,Tabs.const_453,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_334.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_334.startSearch(Tabs.const_295,Tabs.const_290);
         this.var_463.getTab(Tabs.const_295).tabPageDecorator.tabSelected();
      }
