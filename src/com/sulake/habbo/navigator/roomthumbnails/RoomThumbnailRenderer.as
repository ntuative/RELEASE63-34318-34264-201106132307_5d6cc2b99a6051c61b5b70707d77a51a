package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_599:int = 10;
      
      private static const const_1076:int = 32;
      
      private static const const_1545:int = 8;
      
      private static const const_1546:int = -16;
      
      private static const const_1547:int = 40;
      ...
      private var var_990:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         this.var_990 = new ThumbnailImageConfigurations(this._navigator);
      ...
      private function initScreenLocsByPositions() : void
      {
         ...
         this.var_2527 = _loc1_;
      }
      
      private function getLoc(param1:int, param2:int) : Point
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_1076 / 2);
         return new Point(param1 * const_1076 + _loc3_,param2 * const_1545);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_357,HabboWindowStyle.const_47,0 | (!!param3 ? HabboWindowParam.const_43 : HabboWindowParam.const_47),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_990.getImage(ThumbnailEditorModel.const_37,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_990.getImage(ThumbnailEditorModel.const_37,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_990.getImage(ThumbnailEditorModel.const_64,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_990.getImage(ThumbnailEditorModel.const_34,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1546,_loc4_.y + const_1547 - _loc5_.height),null,null,true);
      }
      
      public function getScreenLocForPos(param1:int) : Point
      {
         return Point(this.var_2527[param1]);
      }
   }
}
