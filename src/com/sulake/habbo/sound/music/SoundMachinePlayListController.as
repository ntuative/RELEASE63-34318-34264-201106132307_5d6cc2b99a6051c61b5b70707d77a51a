package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_236:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_236 = param2;
         this.var_848 = [];
         this.var_848.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_848.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_848)
         {
         ...
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_966,this.onSoundMachinePlayEvent);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_857,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_92)
            {
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_966,this.onSoundMachinePlayEvent);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_857,this.onSoundMachineStopEvent);
               this.var_92 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         if(this.var_475 == param1)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_236.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_475 = -1;
         this.var_689 = false;
         this.var_236.stop(HabboMusicPrioritiesEnum.const_121);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_236.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_236.playSong(param1,HabboMusicPrioritiesEnum.const_121,_loc3_,0,0,0))
         {
