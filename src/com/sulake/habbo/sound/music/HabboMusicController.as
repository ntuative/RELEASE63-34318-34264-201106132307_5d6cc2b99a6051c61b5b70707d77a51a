package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1412:int = HabboMusicPrioritiesEnum.const_121;
      ...
      private var var_530:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_848.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_848.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_848)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_807,this.onJukeboxInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_258,this.onJukeboxDispose);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_766,this.onSoundMachineInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_783,this.onSoundMachineDispose);
         this.var_1162 = new Timer(1000);
         this.var_1162.start();
         this.var_1162.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         ...
         {
            this.var_315[_loc6_] = null;
            this.var_768[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1751)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_442)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_848)
               {
            ...
            if(this.var_266)
            {
               ...
               {
                  _loc3_ = this.var_266.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_92)
            {
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_807,this.onJukeboxInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_258,this.onJukeboxDispose);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_766,this.onSoundMachineInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_783,this.onSoundMachineDispose);
            }
      ...
      private function addSongStartRequest(param1:int, param2:int, param3:Number, param4:Number, param5:Number, param6:Number) : Boolean
      {
         ...
         this.var_315[param1] = _loc7_;
         this.var_768[param1] += 1;
         return true;
      }
      
      private function getSongStartRequest(param1:int) : SongStartRequestData
      {
         return this.var_315[param1];
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_315[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_768[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_315.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_315[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_266.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_367.length)
         {
            return this.var_367.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_367.length)
         {
            return this.var_367.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_266.length)
         {
            ...
            if(_loc3_.id != this.var_1452 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_315[_loc2_] != null)
            {
               _loc3_ = this.var_315[_loc2_];
               _loc4_ = this.var_266.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_766));
         Logger.log("Requested song info\'s : " + this.var_766);
         this.var_766 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_266.add(_loc6_.id,_loc10_);
               ...
               while(this.var_767.indexOf(_loc6_.id) != -1)
               {
                  this.var_767.splice(this.var_767.indexOf(_loc6_.id),1);
                  if(this.var_767.length == 0)
                  {
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.var_1751 = this.getSongRequestCountAtPriority(param1);
         this.var_1452 = param2;
         if(this._priorityPlaying <= const_1412)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_121)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_125,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2336 != param1.id || _loc3_ > this.var_2335 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2336 = param1.id;
            this.var_2335 = _loc3_;
         }
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_367.add(_loc5_,_loc6_);
            if(this.var_266.getValue(_loc6_) == null)
            {
               this.var_767.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_530 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_92,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_530 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
