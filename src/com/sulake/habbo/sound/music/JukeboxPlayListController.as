package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_848 = [];
         this.var_848.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_848.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_848.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      {
         this.var_236.stop(this.priority);
         this.var_475 = -1;
         this.var_2124 = -1;
         this.var_689 = false;
      }
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_689 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            this.var_236.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_121,_loc3_.syncCount / 1000,0,1,1);
         ...
         {
            this.var_236.addSongInfoRequest(_loc3_.nextSongId);
         }
         this.var_2124 = _loc3_.currentPosition;
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            _loc7_ = this.var_236.getSongInfo(_loc5_) as SongDataEntry;
            if(_loc7_ == null)
            {
               _loc7_ = new SongDataEntry(_loc5_,-1,null,null,null);
               if(this.var_894.indexOf(_loc5_) < 0)
               {
                  this.var_894.push(_loc5_);
                  this.var_236.requestSongInfoWithoutSamples(_loc5_);
               }
            }
      ...
      private function onJukeboxPlayListFullMessage(param1:IMessageEvent) : void
      {
         ...
         this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_173));
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc2_ < this.length)
         {
            ...
            if(_loc4_.id == param1.id)
            {
               ...
               _loc6_ = this.var_236.getSongInfo(param1.id) as SongDataEntry;
               if(_loc6_ != null)
               {
         ...
         var _loc3_:int = this.var_894.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
