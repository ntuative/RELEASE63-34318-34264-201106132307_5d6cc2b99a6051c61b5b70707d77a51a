package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1558:String = "pixelbalance";
      
      private static const const_1556:String = "badges";
      
      private static const const_1552:String = "selectbadge";
      
      private static const const_1559:String = "inventory";
      
      private static const const_1554:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1555:String = "friendlist";
      
      private static const const_1553:String = "pet_inventory";
      
      private static const const_1557:String = "go_to_room";
      ...
      private var var_393:HabboNotificationViewManager;
      
      private var var_244:HabboAlertDialogManager;
      
      private var var_823:ParkBusDialogManager;
      
      private var var_2559:Boolean;
      
      private var var_998:ClubGiftNotification;
      
      private var var_999:ClubEndingNotification;
      
      private var var_1002:ClubPromoNotification;
      
      private var var_1544:Dictionary;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1809 = false;
         this.var_1544 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1000);
         }
         var _loc6_:Map = this.var_1000["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1000["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_244 = new HabboAlertDialogManager(this._windowManager,this._localization);
         if(this._communication)
         {
      ...
      public function setQuestTrackerHeight(param1:int) : void
      {
         if(this.var_393)
         {
            this.var_393.topMarginIncrease = param1;
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1544[_loc3_.data.badgeCode] = new AchievementNotification(_loc3_.data.badgeCode,_loc3_.data.achievementID,_loc3_.data.level,_loc3_.data.points,_loc3_.data.levelRewardPoints,_loc3_.data.levelRewardPointType,_loc3_.data.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_365);
      }
      
      private function isStandaloneAchievementListEnabled() : Boolean
      {
         return this._config.getKey("standaloneAchievementList.enabled","PresentHandler") == "true";
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1544[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1544[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      {
         this.var_393 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_1000["styles"],this.var_1000["view"]);
         ...
         registerUpdateReceiver(this.var_393,1);
         registerUpdateReceiver(this,2);
         this.var_365.events.addEventListener(BadgeImageReadyEvent.const_118,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_365.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1256,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1256,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1819,null);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_1001.createAvatarImage(param2,AvatarScaleType.const_60);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_365.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_63)
               {
                  _loc7_ = this.var_365.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_365.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1808,_loc5_);
               }
            }
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_63:
               ...
               break;
            case CatalogPageMessageProductData.const_179:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1272)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1858,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1804)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_999 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1002 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_393.isSpaceAvailable() && this.var_1234.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_393.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      {
         if(param1 != null && this.var_393 != null)
         {
            this.var_393.replaceIcon(param1);
         }
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_244 == null)
         {
            return;
         }
         this.var_244.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_244.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_244.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_244.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_244.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_823 == null)
         {
            this.var_823 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_823 != null)
         {
            this.var_823.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1239,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1239,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1001.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_60);
            if(_loc6_ != null)
            {
      ...
      {
         if(param2.type == WindowEvent.const_177 || param2.type == WindowEvent.const_531)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_998 && this.var_998.visible)
         {
            return;
         }
         this.var_998 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
