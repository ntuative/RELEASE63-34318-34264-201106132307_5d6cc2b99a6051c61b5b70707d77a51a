package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2111:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_804 = new ColorTransform(this.var_2111,this.var_2113,this.var_2112,this._alphaMultiplier);
         this.var_1373 = this.generatePaletteMapForGrayscale(this.var_2958,this.var_2959);
      }
      ...
      {
         return this.var_1373.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1373.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1373.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1373.getValue("alphas") as Array;
      }
