package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2314:String = "hd-99999-99999";
      ...
      private var var_870:PaletteManager;
      ...
      private var var_2051:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_726 = RenderMode.const_1904;
         ...
         this.var_119.add(AvatarType.const_58,_loc4_);
         ...
         this.var_870 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         if(_loc2_)
         {
            ...
            _loc2_.method_7(context.assets as AssetLibraryCollection,"fx",200);
            _loc2_.method_7(context.assets as AssetLibraryCollection,"dance",200);
         }
         _loc2_ = this.var_119.getValue(AvatarType.const_58) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_ != null)
            {
               _loc4_ = this.var_169.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_253 == null)
               {
                  ...
                  _loc6_ = this.var_169.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_169.getKey("flash.dynamic.avatar.download.url","");
      ...
      private function checkIfReady() : void
      {
         if(!this.var_970)
         {
            if(this.var_2819 && this.var_2818 && this.var_2820)
            {
               this.var_970 = true;
      ...
      public function createAvatarImage(param1:String, param2:String, param3:String = null, param4:IAvatarImageListener = null) : IAvatarImage
      {
         ...
         if(!this.var_2051)
         {
            this.var_2051 = new AvatarFigureContainer(this.const_2314);
         }
         this.var_253.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2051,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1754)
         {
            _loc6_ = !this.var_332.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_332.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_119.getValue(AvatarType.const_58) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_119.getValue(AvatarType.const_58);
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_58:
               _loc3_ = this.var_119.getValue(AvatarType.const_58) as AvatarStructure;
               break;
            default:
