package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_472:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         {
            this.var_472 = this._window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      
      public function udpate(param1:BitmapData) : void
      {
         if(this.var_472 && this.var_1262)
         {
            this.var_472.bitmap = new BitmapData(this.var_472.width,this.var_472.height,true,16777215);
            this.var_472.bitmap.copyPixels(this.var_1262,this.var_1262.rect,new Point(0,this.var_472.height - this.var_1262.height - 8));
            this.var_472.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
