package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_892:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_268:AvatarImageCache;
      
      protected var var_677:AvatarFigureContainer;
      
      protected var var_594:IAvatarDataContainer;
      ...
      private var var_2315:String = null;
      
      private var var_2314:String = null;
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_1121)
         {
            ...
            if(this.var_760)
            {
               for each(_loc2_ in this.var_760)
               {
                  _loc2_.dispose();
               }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_52 || param1 == AvatarSetType.const_41)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_265.length == 1 && this.var_100 == this.var_2140)
         {
            return this.var_100 + this.var_522 + this.var_621 % 4;
         }
         if(this.var_265.length == 2)
         {
            for each(_loc1_ in this.var_265)
            {
               ...
               {
                  return this.var_100 + this.var_522 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_621 % 11;
                  return this.var_100 + "_" + this.var_2140 + this.var_522 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2313 || param2 != this.var_2315 || param1 != this.var_2314)
         {
            this.var_2313 = param3;
            this.var_2315 = param2;
            this.var_2314 = param1;
            this.var_1736 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_304.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1388 || this.var_48 == null || (this.var_48.width != _loc5_.width || this.var_48.height != _loc5_.height))
         {
            if(this.var_48 != null && !this.var_1388)
            {
               this.var_48.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_304.definition.geometryType,this.var_100);
         this.var_48.lock();
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_352.push(new ActiveActionData(param1,param2,this.var_621));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_940);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_522 = "";
         this.var_265 = this._structure.sortActions(this.var_352);
         if(this.var_265 == null)
         {
         ...
         {
            this.var_892 = this._structure.getCanvasOffsets(this.var_265,this._scale,this.var_100);
            for each(_loc4_ in this.var_265)
            {
               this.var_522 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_325)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1443 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1443 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_265)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_939 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_342 || _loc1_.actionType == AvatarAction.const_269 || _loc1_.actionType == AvatarAction.const_403)
               {
                  this.var_939 = true;
               }
            }
