package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyModel extends CategoryBaseModel implements IAvatarEditorCategoryModel, IAvatarImageListener
   {
      ...
      {
         var _loc4_:CategoryData = var_114[param1];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      override protected function updateSelectionsFromFigure(param1:String) : void
      {
         ...
         var _loc2_:int = var_29.figureData.getPartSetId(FigureData.const_94);
         var _loc3_:Array = var_29.figureData.getColourIds(FigureData.const_94);
         var _loc4_:CategoryData = var_114[param1];
         if(_loc4_ == null)
         {
            return;
         ...
         for each(_loc5_ in _loc4_.parts)
         {
            ...
            _loc7_ = var_29.manager.avatarRenderManager.createAvatarImage(_loc6_,AvatarScaleType.const_60,null,this);
