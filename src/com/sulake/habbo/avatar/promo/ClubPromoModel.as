package com.sulake.habbo.avatar.promo
{
   ...
   public class ClubPromoModel implements ISideContentModel
   {
      ...
      public function tryClubClothes() : void
      {
         ...
         if(this.var_29)
         {
            this.var_29.useClubClothing();
         }
         if(this.var_29.manager.communication)
         {
            this.var_29.manager.communication.getHabboMainConnection(null).send(new EventLogMessageComposer("AvatarEditor","click","try_club_clothes",""));
         }
      }
