package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorMessageHandler
   {
      ...
      private var var_29:HabboAvatarEditorManager;
      ...
      {
         if(param1 == null || !this.var_29)
         {
            return;
         }
         var _loc2_:HabboAvatarEditor = this.var_29.getEditor(AvatarEditorInstanceId.const_212);
         if(_loc2_)
         {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc2_.clubMemberLevel = this.var_29.sessionData.clubLevel;
            _loc2_.update();
         }
      }
   }
