package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_1017:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_986 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_656.width,this.var_656.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_656,this.var_656.rect,new Point(0,0));
         }
         ...
         if(_loc2_ != null)
         {
            ...
            _loc5_.colorTransform(_loc5_.rect,this.var_1017.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_986.width,this.var_986.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_986,this.var_986.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_1017)
            {
               switch(this.var_1017.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_46:
                     _loc4_.style = HabboIconType.const_791;
                     _loc4_.visible = true;
               }
            }
            else
