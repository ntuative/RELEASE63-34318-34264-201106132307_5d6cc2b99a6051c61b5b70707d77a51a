package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseView
   {
      ...
      protected var var_163:String = "";
      
      protected var var_50:String = "";
      
      protected var var_76:IAvatarEditorCategoryModel;
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_2195);
      ...
      protected function updateGridView() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = this.var_41[this.var_163];
         if(_loc2_ == null)
         {
            return;
         }
