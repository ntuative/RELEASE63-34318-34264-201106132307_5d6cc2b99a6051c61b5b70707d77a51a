package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit, IAvatarImageListener
   {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IAvatarImage = this.var_29.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_114,this.var_1036,this);
         if(_loc1_)
         {
            _loc1_.setDirection(AvatarSetType.const_41,int(FigureData.const_821));
