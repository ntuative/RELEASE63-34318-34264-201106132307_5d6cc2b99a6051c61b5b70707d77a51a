package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_494:AvatarRenderManager;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_932:AvatarActionManager;
      ...
      private var var_755:AnimationManager;
      
      private var var_940:ActionDefinition;
      
      private var var_516:String;
      
      private var var_1432:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         ...
         this.var_430 = new PartSetsData();
         this._animationData = new AnimationData();
         this.var_755 = new AnimationManager();
         this.var_516 = param2;
      ...
      {
         this.var_1432.loadOffsets(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_516);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_516);
            return;
         }
         this.var_932 = new AvatarActionManager(param1,this.var_516,param2);
         this.var_940 = this.var_932.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_516);
            return false;
         }
         if(this.var_430.parse(param1))
         {
            if(this.var_516 == AvatarType.const_127)
            {
               this.var_430.getPartDefinition("ri").appendToFigure = true;
               this.var_430.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_516);
            return false;
         }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_516);
            return false;
         }
      ...
      public function method_7(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         var _loc4_:* = null;
         var _loc5_:int = 0;
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_755.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      {
         return this.var_755.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_755.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_932.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_932.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_932.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         this.var_618[param1][param2] = this.var_361.getMandatorySetTypeIds(param1,param2);
         return this.var_618[param1][param2];
      }
      ...
      {
         return this.var_932.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_755.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_430.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_430.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1984[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_430.getActiveParts(param3.definition);
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc9_ = this.var_755.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           {
                              _loc33_ = this.var_940;
                           }
                           _loc12_ = this.var_430.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_430.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         return this.var_1432.getOffset(param1,param2,param3,param4,param5,param6);
      }
