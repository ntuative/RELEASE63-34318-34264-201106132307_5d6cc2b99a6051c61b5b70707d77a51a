package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditorManager extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_1135:AvatarEditorMessageHandler;
      ...
      public function close(param1:uint) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorInstanceId.const_212:
               _loc2_.hide();
               break;
            case AvatarEditorInstanceId.const_392:
               _loc2_.hide();
               _loc2_.dispose();
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_1001 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1135 = new AvatarEditorMessageHandler(this,this._communication);
      }
