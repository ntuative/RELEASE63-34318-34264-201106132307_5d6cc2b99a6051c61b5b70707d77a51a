package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1407:String = "Default";
      
      private static const const_1409:int = 2;
      
      private static const const_1408:String = AvatarSetType.const_41;
      ...
      protected var var_100:int;
      
      protected var var_304:IActiveActionData;
      
      protected var var_1121:Boolean;
      
      private var var_940:IActiveActionData;
      
      private var _assets:AssetAliasCollection;
      
      private var var_268:AvatarImageCache;
      
      private var var_621:int = 0;
      
      private var var_1735:int = 0;
      
      private var var_677:AvatarFigureContainer;
      
      private var var_620:Boolean;
      
      private var var_223:Array;
      
      private var var_594:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_677 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_677.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1445 = this.var_1295;
         this.var_268 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1408,const_1409);
         this.var_352 = new Array();
         this.var_940 = new ActiveActionData(AvatarAction.const_393);
         this.var_940.definition = this._structure.getActionDefinition(const_1407);
         this.resetActions();
      }
      ...
      {
         return this._structure.getPartColor(this.var_677,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += this.var_1735;
         if(param2 < AvatarDirectionAngle.const_1294)
         {
            param2 = AvatarDirectionAngle.const_336 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_336)
         {
            param2 -= NaN;
         }
         if(param1 == AvatarSetType.const_52)
         {
            if((this.var_100 == 6 || this.var_100 == 0) && param2 == 7)
            {
               param2 = this.var_100;
            }
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1445);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_304.definition.geometryType);
         if(this.var_48 == null || _loc4_ != null && (this.var_48.width != _loc4_.width || this.var_48.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_304.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_304.definition.geometryType,this.var_100);
         this.var_48.lock();
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_677,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1445 < 3;
               _loc17_ = !!_loc16_ ? 32 : 67;
               if(this._scale == AvatarScaleType.const_114)
               {
               ...
               if(_loc15_.length > 0)
               {
                  ...
                  if(_loc22_ != null)
                  {
                     ...
                     _loc11_.y += _loc22_.y;
                     if(this.var_100 == 7 && _loc12_.getDirection() == 6)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_100 == 4 && _loc12_.getDirection() == 3)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                     else if(this.var_100 == 3 && _loc12_.getDirection() == 4)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_100 == 6 && _loc12_.getDirection() == 7)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                  }
         ...
         {
            if(this.var_594.paletteIsGrayscale)
            {
               ...
               this.var_48 = _loc23_;
               this.var_48.paletteMap(this.var_48,this.var_48.rect,new Point(0,0),this.var_594.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_304.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_677,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_114)
               {
                  _loc17_ = 6;
               ...
               if(_loc16_.length > 0)
               {
                  ...
                  if(_loc23_ != null)
                  {
                     ...
                     _loc12_.y += _loc23_.y;
                     if(this.var_100 == 7 && _loc13_.getDirection() == 6)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_100 == 4 && _loc13_.getDirection() == 3)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                     else if(this.var_100 == 3 && _loc13_.getDirection() == 4)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_100 == 6 && _loc13_.getDirection() == 7)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                  }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_522 = this.var_522 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_424:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1883:
                  case AvatarAction.const_1709:
                  case AvatarAction.const_1985:
                  case AvatarAction.const_1218:
                  case AvatarAction.const_1227:
                  case AvatarAction.const_1983:
                  case AvatarAction.const_1718:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_352.length)
         {
            _loc3_ = this.var_352[_loc4_];
         ...
         this.var_352.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_594 = null;
         this.var_1735 = 0;
         this.var_304 = this.var_940;
         this.var_304.definition = this.var_940.definition;
         this.setActionToParts(this.var_940);
         this.getCache().resetBodyPartCache(this.var_940);
         return true;
      }
      ...
      {
         this.var_1444 = true;
         if(this.var_1150 == this.var_522)
         {
            return;
         }
         this.var_1150 = this.var_522;
         this.var_1446 = this._structure.sortActions(this.var_352);
         if(this.var_1446 == null)
         {
            this.var_892 = new Array(0,0,0);
         }
         else
         {
            this.var_892 = this._structure.getCanvasOffsets(this.var_1446,this._scale,this.var_100);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1446)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     this.var_223 = this.var_223.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1735 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_594 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_403)
               {
                  this.var_939 = true;
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_342)
               {
                  this.var_939 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1295 = _loc4_.id;
                     this.var_1737 = _loc4_.breed;
                     break;
                  }
               }
            }
