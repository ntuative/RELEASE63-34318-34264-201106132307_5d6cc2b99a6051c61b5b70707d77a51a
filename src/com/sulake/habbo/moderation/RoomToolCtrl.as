package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_583:ITextFieldWindow;
      
      private var var_608:Boolean = true;
      
      private var var_1054:ICheckBoxWindow;
      
      private var var_1594:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_37.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_397));
         Logger.log("BEGINNING TO SHOW: " + this.var_397);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_397);
         if(param1.flatId != this.var_397)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_397);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_583 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_583.procedure = this.onInputClick;
         this.var_1272 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1272);
         this.var_1272.procedure = this.onSelectTemplate;
         this.var_1054 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1594 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1595 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_37,WindowTracker.const_892,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_608 || this.var_583.text == "")
         {
            this.var_37.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1054.isSelected);
         this.var_37.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1838,_loc2_,this.var_583.text,"",""));
         if(this.var_1594.isSelected || this.var_1595.isSelected || this.var_1054.isSelected)
         {
            this.var_37.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1594.isSelected,this.var_1595.isSelected,this.var_1054.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1731);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1840);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_37.initMsg.roomMessageTemplates[this.var_1272.selection];
         if(_loc3_ != null)
         {
            this.var_608 = false;
            this.var_583.text = _loc3_;
         }
      }
   }
}
