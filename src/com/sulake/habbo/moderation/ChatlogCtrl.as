package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_979:Array = [];
      
      private static var var_1836:int = 1000;
      
      private static var var_978:Array = [];
      
      private static var var_1839:int = 200;
      ...
      private var var_1837:IMessageComposer;
      ...
      private var var_1838:Dictionary;
      ...
      {
         this.var_803 = IWindowContainer(this.var_37.getXmlWindow("chatlog_roomheader"));
         this.var_802 = IWindowContainer(this.var_37.getXmlWindow("chatlog_chatline"));
         this.var_568 = new Timer(1000,1);
         ...
         this.var_66 = IItemListWindow(this._frame.findChildByName("chatline_list"));
         this._frame.procedure = this.onWindow;
         var _loc1_:IWindow = this._frame.findChildByTag("close");
         _loc1_.procedure = this.onClose;
         this.var_37.connection.send(this.var_1837);
      ...
      private function populateRoomChat(param1:RoomChatlogData) : void
      {
         ...
         this.addHeaderLineToList(_loc2_,this.var_66);
         var _loc4_:* = true;
         for each(_loc5_ in param1.chatlog)
         {
            this.populateChatline(this.var_66,_loc5_,_loc4_);
            _loc4_ = !_loc4_;
         }
      }
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_979.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_978.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_803.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_978.length < var_1839)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_803.width;
            param1.height = this.var_803.height;
            var_978.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1838[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1520.getValue(param2.chatterName))
            {
               this.var_1520.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1520.getValue(_loc2_);
      ...
      private function refreshListDims() : void
      {
         ...
         var _loc2_:* = null;
         this.var_66.autoArrangeItems = false;
         var _loc3_:int = this.var_66.numListItems;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc1_ = IWindowContainer(this.var_66.getListItemAt(_loc4_));
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1521)
         {
