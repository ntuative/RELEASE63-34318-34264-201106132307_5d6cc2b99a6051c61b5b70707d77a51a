package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_892:int = 4;
      
      public static const const_1249:int = 5;
      
      public static const const_1910:int = 6;
      
      public static const const_1763:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1844:int = 9;
       
      
      private var var_2138:Dictionary;
      
      public function WindowTracker()
      {
         this.var_2138 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_2138[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_2138[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
