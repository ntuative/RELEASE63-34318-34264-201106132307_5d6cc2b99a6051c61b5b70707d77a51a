package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_174:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_555:UserInfoCtrl;
      
      private var var_1218:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_174.getHighestPriorityIssue();
         this.var_555 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
         this.var_1218 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
         this.var_555.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_174.reportedUserId > 0)
         {
            this.var_1218.load(_loc4_,this.var_174.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_174.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_174.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_74 != null && this.var_74.issueManager != null && this.var_174 != null)
         {
            this.var_74.issueManager.removeHandler(this.var_174.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_174.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_174.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_174.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.releaseBundle(this.var_174.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_174.getHighestPriorityIssue().issueId;
         this.var_74.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_74,WindowTracker.const_1334,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_174.getHighestPriorityIssue();
            this.var_555 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
            this.var_555.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
