package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1029:int = 3600;
      
      private static const const_1028:int = 86400;
      
      private static const const_1026:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1027)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1029)
         {
            return Math.round(param1 / const_1027) + " mins ago";
         }
         if(param1 < 2 * const_1028)
         {
            return Math.round(param1 / const_1029) + " hours ago";
         }
         if(param1 < 2 * const_1026)
         {
            return Math.round(param1 / const_1028) + " days ago";
         }
         return Math.round(param1 / const_1026) + " years ago";
      }
      ...
      public function load(param1:IWindowContainer, param2:int) : void
      {
         ...
         this._data = null;
         this.refresh();
         this.var_37.messageHandler.addUserInfoListener(this);
         this.var_37.connection.send(new GetModeratorUserInfoMessageComposer(param2));
      }
      ...
      public function dispose() : void
      {
         ...
         this._disposed = true;
         this.var_37.messageHandler.removeUserInfoListener(this);
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1153.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_37.getXmlWindow("user_info"));
            this.var_1153.addChild(_loc1_);
            this.var_37.disableButton(this.var_37.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            this.var_37.disableButton(this.var_37.initMsg.alertPermission,_loc1_,"message_but");
            this.var_37.disableButton(this.var_37.initMsg.alertPermission || this.var_37.initMsg.kickPermission || this.var_37.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_37,WindowTracker.const_1249,this._data.userId),this._callerFrame,this.var_1154,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new RoomVisitsCtrl(this.var_37,this._data.userId),this._callerFrame,this.var_1154,false,true);
      }
      ...
      private function onHabboInfoToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.openHkPage("habboinfotool.url",this._data.userName);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new SendMsgsCtrl(this.var_37,this._data.userId,this._data.userName,this.var_1648),this._callerFrame,this.var_1154,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new ModActionCtrl(this.var_37,this._data.userId,this._data.userName,this.var_1648),this._callerFrame,this.var_1154,false,true);
      }
      ...
      {
         this.var_37.openHkPage("moderatoractionlog.url",this._data.userName);
      }
   }
}
