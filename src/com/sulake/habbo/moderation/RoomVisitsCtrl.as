package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1110:Array = [];
      
      private static var var_2141:int = 200;
      ...
      {
         this.var_898 = IWindowContainer(this.var_37.getXmlWindow("roomvisits_row"));
         this.var_568 = new Timer(300,1);
         this.var_568.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
         this.var_37.messageHandler.addRoomVisitsListener(this);
         this.var_37.connection.send(new GetRoomVisitsMessageComposer(this._userId));
         this._frame = IFrameWindow(this.var_37.getXmlWindow("roomvisits_frame"));
         this.var_66 = IItemListWindow(this._frame.findChildByName("visits_list"));
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         this.var_37.messageHandler.removeRoomVisitsListener(this);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1910;
      }
      ...
      private function populateRoomRow(param1:RoomVisitData, param2:Boolean) : void
      {
         ...
         new OpenRoomTool(this._frame,this.var_37,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
         ...
         new OpenRoomInSpectatorMode(this.var_37,_loc7_,param1.isPublic,param1.roomId);
         _loc7_.color = _loc4_;
         this.addRoomRowToList(_loc3_,this.var_66);
      }
      
      private function addRoomRowToList(param1:IWindowContainer, param2:IItemListWindow) : void
      {
         param2.addListItem(param1);
         this.var_1657.push(param1);
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1110.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_898.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1110.length < var_2141)
         {
            ...
            param1.width = this.var_898.width;
            param1.height = this.var_898.height;
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this.var_66.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = this.var_66.scrollableRegion.height > this.var_66.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
               _loc3_.visible = false;
               this.var_66.width += 17;
            }
         }
         else if(_loc4_)
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1657)
         {
