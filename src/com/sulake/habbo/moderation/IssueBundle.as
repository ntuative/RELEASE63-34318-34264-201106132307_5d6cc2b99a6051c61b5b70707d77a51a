package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_834:IssueMessageData = null;
      
      private var var_835:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2432 = param2.pickerUserId;
         this.var_2674 = param2.pickerUserName;
         this.var_1609 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1269 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1268;
         }
         if(this.var_834 == null || param1.timeStamp < this.var_834.timeStamp)
         {
            this.var_834 = param1;
         }
         if(this.var_835 == null || param1.priority > this.var_835.timeStamp)
         {
            this.var_835 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1269 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1268;
            }
            if(this.var_834 == _loc2_)
            {
               this.var_834 = null;
            }
            if(this.var_835 == _loc2_)
            {
               this.var_835 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_835;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_834;
         if(_loc2_ == null)
         {
