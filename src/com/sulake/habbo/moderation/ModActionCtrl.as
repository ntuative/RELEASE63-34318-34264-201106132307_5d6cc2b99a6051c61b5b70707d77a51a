package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1352:IDropMenuWindow;
      ...
      private var var_1099:OffenceCategoryData;
      
      private var var_1098:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1350 = IButtonWindow(this.var_37.getXmlWindow("modact_offence"));
         this.var_1351 = IButtonWindow(this.var_37.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1975;
         ...
         this.var_1352 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1352);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1099 != null;
         if(this.var_1098 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1098.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1099 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1099.offences,this.var_1350,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_37.initMsg.offenceCategories,this.var_1351,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.connection.send(new ModAlertMessageComposer(this.var_1647,this.var_583.text,this.var_1648));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1099 = this.var_37.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1098 = this.var_1099.offences[_loc3_];
         this.var_583.text = this.var_1098.msg;
         this.var_608 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.connection.send(new ModKickMessageComposer(this.var_1647,this.var_583.text,this.var_1648));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1352.selection < 0)
         {
            this.var_37.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_37.connection.send(new ModBanMessageComposer(this.var_1647,this.var_583.text,this.getBanLength(),this.var_1648));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1352.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1350.destroy();
            this.var_1350 = null;
         }
         if(this.var_1351 != null)
         {
            this.var_1351.destroy();
            this.var_1351 = null;
         }
         this.var_1352 = null;
         this.var_583 = null;
