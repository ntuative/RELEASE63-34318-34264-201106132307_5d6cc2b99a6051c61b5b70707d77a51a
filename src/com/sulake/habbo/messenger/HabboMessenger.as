package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_464:Conversations;
      ...
      {
         if(this._windowManager && this._communication && this.var_169 && this._localization && this._friendList && this.var_793 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_464 = new Conversations(new ConversationsDeps(this));
      ...
      {
         var _loc2_:Conversation = this.var_464.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_464.setSelected(_loc2_);
      ...
      {
         return !!this.var_464 ? this.var_464.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_464.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_464.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = this.var_169.getKey("url.prefix",_loc2_);
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_983,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      {
         this.var_464.addMessageAndUpdateView(param1);
         if(!this.var_201.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1308);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1161,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_464.addMessageAndUpdateView(_loc3_);
      }
