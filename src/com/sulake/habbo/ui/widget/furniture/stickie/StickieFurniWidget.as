package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1645:int = 14;
      
      private static const const_1644:int = 500;
      
      private static const const_1434:Number = 100;
      
      private static const const_1433:Number = 100;
      ...
      protected var var_354:String;
      
      protected var var_29:Boolean;
      
      protected var var_2221:String = "stickieui_container";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_908,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_908,this.onObjectUpdate);
      }
      ...
      protected function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1400 = param1.objectType;
         this._text = param1.text;
         this.var_354 = param1.colorHex;
         this.var_29 = param1.controller;
         this.showInterface();
      }
      ...
      protected function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow(this.var_2221,"",HabboWindowType.const_78,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1434,const_1433,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null)
         {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + this.var_354);
            }
         ...
         this.setColorButtons(this.var_29 && this.var_1400 == "post_it");
      }
      ...
      protected function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_621,this.var_234,this._text,this.var_354);
      ...
      protected function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_621,this.var_234,this._text,this.var_354);
      ...
      protected function sendDelete() : void
      {
         ...
         if(messageListener != null && this.var_29)
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_756,this.var_234);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1644;
         if(_loc2_.numLines < const_1645)
         {
            return;
         }
