package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_686:String = "welcome_gift_email_unverified";
      
      private const const_1062:String = "welcome_gift_email_verified";
      
      private const const_1517:String = "welcome_gift_email_change";
      
      private const const_2294:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1206)
         {
            this.setViewState(this.const_1062);
         }
         else
         {
            this.setViewState(this.const_686);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_686:
               ...
               this._view.findChildByName("edit_text").visible = this.var_975;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_975);
               break;
            case this.const_1062:
            ...
            case this.const_1517:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_975);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1514;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1517);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_728,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1206 ? this.const_1062 : this.const_686);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1513 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1513));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_794,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_794,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_579:
               this.var_1514 = param1.email;
               this.var_1206 = param1.isVerified;
               this.var_975 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1514 = this.var_1513;
            this.setViewState(this.const_686);
         }
         else
         {
            if(param1.result == this.const_2294)
            {
               this.var_975 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1513);
