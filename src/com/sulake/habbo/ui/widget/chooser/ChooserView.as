package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_2034:uint = 0;
      
      private const const_2305:uint = 4.282169599E9;
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(this.const_2034) : uint(this.const_2033);
      ...
      {
         var _loc2_:* = null;
         if(this._itemList == null || param1 < 0 || param1 > this._itemList.numListItems || param1 == this.var_995)
         {
            return;
         }
         if(this.var_995 != -1)
         {
            _loc2_ = this._itemList.getListItemAt(this.var_995) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_995 % 2) ? uint(this.const_2034) : uint(this.const_2033);
            }
         }
         _loc2_ = this._itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = this.const_2305;
            this.var_995 = param1;
         }
      }
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         this.populate(this._items,this.var_1915);
      }
