package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      public function destroy() : void
      {
         ...
         {
            this.var_684.destroyGridItems();
            this.var_684 = null;
         }
         if(this.var_236 != null)
         {
            if(this.var_236.events != null)
            {
      ...
      public function refresh() : void
      {
         ...
         this._items = new Map();
         var _loc4_:int = this.var_236.getSongDiskInventorySize();
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc7_ = this.var_236.getSongDiskInventoryDiskId(_loc5_);
            _loc8_ = this.var_236.getSongDiskInventorySongId(_loc5_);
            _loc9_ = this.var_236.getSongInfo(_loc8_);
            _loc10_ = null;
            _loc11_ = null;
            if(_loc9_ != null)
            {
            ...
            this.var_684.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_111.playButtonState = MusicInventoryGridItem.const_1195;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_111 != null)
         {
            this.var_111.playButtonState = MusicInventoryGridItem.const_652;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_111.playButtonState == MusicInventoryGridItem.const_652)
               {
                  this.var_111.playButtonState = MusicInventoryGridItem.const_1324;
            ...
            {
               _loc4_ = this.var_684.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
