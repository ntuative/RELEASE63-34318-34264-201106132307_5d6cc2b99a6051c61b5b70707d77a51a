package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_955:String = "PLSV_ADD_SONGS";
      
      public static const const_1304:String = "PLSV_START_PLAYBACK";
      
      public static const const_545:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_52 != const_545)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_487[this.var_52];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_487[const_955];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_487.add(const_545,_loc1_);
