package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3041:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3041 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_457:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_70,this.var_154,this.var_2902++,this,this._questEngine);
               break;
            case RoomWidgetEnum.const_347:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_70,this.var_154,this);
               break;
            case RoomWidgetEnum.const_625:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_70,this.var_154,this._catalog);
               break;
            case RoomWidgetEnum.const_571:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_70,events,this.var_154);
               break;
            ...
            case RoomWidgetEnum.const_512:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_70,this.var_154,this.var_13);
               break;
            ...
            case RoomWidgetEnum.const_568:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_70,this.var_154);
               break;
            case RoomWidgetEnum.const_589:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_70,this.var_154);
               break;
            case RoomWidgetEnum.const_138:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_70,this.var_154);
               break;
            ...
            case RoomWidgetEnum.const_132:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_154,this.var_70,this);
               break;
            ...
            case RoomWidgetEnum.const_643:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_70,this.var_154,this._catalog);
               break;
