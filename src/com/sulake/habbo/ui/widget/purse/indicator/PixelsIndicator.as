package com.sulake.habbo.ui.widget.purse.indicator
{
   ...
   public class PixelsIndicator implements ICurrencyIndicator
   {
      ...
      private const const_2302:uint = 4.28366404E9;
      
      private var _view:IWindowContainer;
      
      private var var_2507:IRoomWidgetMessageListener;
      ...
      public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPurseUpdateEvent.const_115,this.onPixelBalance);
      }
      ...
      public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPurseUpdateEvent.const_115,this.onPixelBalance);
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_1867 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_1867.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_1867.toString();
         }
      }
      
      private function onPixelsClick(param1:WindowMouseEvent) : void
      {
         this.var_2507.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1182));
      }
      
      private function onBlueMouseOver(param1:WindowMouseEvent) : void
      {
         this._view.color = this.const_2302;
      }
      
      private function onBlueMouseOut(param1:WindowMouseEvent) : void
      {
         this._view.color = this.const_2301;
      }
   }
}
