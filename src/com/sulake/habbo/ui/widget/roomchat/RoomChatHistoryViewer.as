package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1660:int = 18;
      ...
      private var var_205:RoomChatHistoryPulldown;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_1121 = false;
         this._widget = param1;
         this.var_205 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         this.var_205.state = RoomChatHistoryPulldown.const_286;
         ...
         this.var_53 = param2.createWindow("chatscroller","",HabboWindowType.const_1296,HabboWindowStyle.const_47,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_205.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_286);
      }
      ...
      {
         return !!this.var_491 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_205.state == RoomChatHistoryPulldown.const_416 || this.var_205.state == RoomChatHistoryPulldown.const_603;
      }
      ...
      {
         if(!this.var_491 && !this.var_1809)
         {
            this.var_491 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_205.state = RoomChatHistoryPulldown.const_416;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_53 != null)
         {
            ...
            if(param2)
            {
               this.var_53.scrollV = this.var_711;
            }
         }
         if(this.var_205 != null)
         {
            this.var_205.containerResized(param1);
         }
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_492 > 0 && param2)
         {
            if(this.var_2090)
            {
               if(Math.abs(param1 - this.var_492) <= const_1235)
               {
                  return;
               }
               this.var_2090 = false;
            ...
            if(this.var_491)
            {
               ...
               _loc5_ = (param1 - this.var_492) / this.var_53.height;
               _loc3_ = this.var_711 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_492;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_53.scrollV < 1 - const_1660 / this.var_53.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_2091)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_53 != null)
         {
            this.var_711 = this.var_53.scrollV;
         }
         if(this.var_53 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_711 - this.var_53.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
