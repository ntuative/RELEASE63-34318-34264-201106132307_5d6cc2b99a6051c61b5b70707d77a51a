package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandSongDiskView extends InfoStandFurniView
   {
      ...
      {
         super.update(param1);
         this.var_1799 = this.getSongIdFromExtraParam(param1.extraParam);
      }
      
      public function updateSongInfo(param1:RoomWidgetSongUpdateEvent) : void
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_418 && param1.songId == this.var_1799)
         {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_259 = var_47.findChildByTag("catalog");
         if(var_259 != null)
         {
            var_259.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
      ...
      private function getSongIdFromExtraParam(param1:String) : int
      {
         ...
         if(param1 != null)
         {
            _loc2_ = param1.substr(RoomWidgetInfostandExtraParamEnum.const_425.length,param1.length);
