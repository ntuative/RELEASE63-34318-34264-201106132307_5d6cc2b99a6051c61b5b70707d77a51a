package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_106:IWindowContainer;
      
      private var var_47:IBorderWindow;
      
      private var var_954:TagListRenderer;
      
      private var var_152:IBorderWindow;
      
      private var var_2501:int;
      
      private var var_2500:Boolean = true;
      
      private const const_1068:int = 5;
      
      private const const_2297:int = 3;
      
      private const const_1522:int = 11184810;
      
      private const const_1523:int = 16777215;
      
      private const const_2299:int = 2000;
      
      private const const_2300:int = 50;
      
      private const const_2298:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_954 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2500 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      {
         if(this.var_54 == null || this.var_47 == null || this.var_106 == null)
         {
            return;
         }
         this.var_54.height = this.var_54.scrollableRegion.height;
         this.var_47.height = this.var_54.height + 20;
         this._window.width = Math.max(this.var_47.width,this.var_106.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_47.width < this.var_106.width)
         {
         ...
         {
            this.var_106.x = this._window.width - this.var_106.width;
            this.var_47.x = 0;
         }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_106 = this._window.getListItemByName("button_list") as IWindowContainer;
         var _loc3_:* = [];
         this.var_106.groupChildrenWithTag("CMD_BUTTON",_loc3_,true);
         ...
         var _loc9_:IWindowContainer = this.var_54.getListItemByName("motto_container") as IWindowContainer;
         if(_loc9_)
         {
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_152.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_152.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_152.x = _loc5_.left - this.var_152.width;
         this.var_152.y = _loc5_.top + (_loc5_.height - this.var_152.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_152.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_152.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_152.x = _loc7_.left - this.var_152.width;
         this.var_152.y = _loc7_.top + (_loc7_.height - this.var_152.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_152 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_152 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1068;
      ...
      {
         var _loc3_:IWindowContainer = this.var_54.getListItemByName("motto_container") as IWindowContainer;
         if(!_loc3_)
         {
            return;
         }
         ...
         var _loc6_:IWindowContainer = this.var_54.getListItemByName("motto_spacer") as IWindowContainer;
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1522;
            }
            else
            {
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1068,this.const_2300);
         _loc5_.height = Math.max(_loc5_.height,this.const_2298);
         _loc3_.height = _loc5_.height + this.const_2297;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_373,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_373,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_954.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_111);
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_106.getChildByName(param1) as IRegionWindow;
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = this.var_106.getChildByName(param1);
         if(_loc3_ != null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_997:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:IWindowContainer = this.var_54.getListItemByName("motto_container") as IWindowContainer;
         if(!_loc2_)
         {
            return;
         }
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2501 > this.const_2299 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2501 = _loc6_;
               _loc3_.textColor = this.const_1523;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1522;
         }
      }
      ...
      {
         var _loc5_:* = null;
         this.var_106.width = 250;
         var _loc2_:* = [];
         this.var_106.groupChildrenWithTag("CMD_BUTTON_REGION",_loc2_,true);
         var _loc3_:int = 250;
         var _loc4_:int = 0;
