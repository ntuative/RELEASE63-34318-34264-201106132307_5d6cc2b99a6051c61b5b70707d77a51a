package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1459:int = 152;
      
      private static const const_1463:int = 16;
      
      private static const const_678:int = 4;
      
      private static const const_1456:uint = 14342874;
      
      private static const const_1461:uint = 3815994;
      
      private static const const_1465:uint = 2085362;
      
      private static const const_1458:uint = 39616;
      
      private static const const_1457:uint = 10513106;
      
      private static const const_1455:uint = 8734654;
      
      private static const const_1460:uint = 9094430;
      
      private static const const_1464:uint = 6200576;
      
      private static const const_1462:String = "happiness";
      
      private static const const_1468:String = "experience";
      
      private static const const_1467:String = "energy";
      
      private static const const_1466:int = 250;
      ...
      private var var_214:PetCommandTool;
      ...
      private function updateWindow() : void
      {
         ...
         this.var_106.width = this.var_106.width;
         this.var_106.visible = this.var_106.width > 0;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1462,param1.nutrition,param1.nutritionMax,const_1458,const_1465);
         this.updateStateElement(const_1468,param1.experience,param1.experienceMax,const_1455,const_1457);
         this.updateStateElement(const_1467,param1.energy,param1.energyMax,const_1464,const_1460);
         ...
         if(this.var_214 && this.var_214.isVisible() && param1.isOwnPet)
         {
            this.var_214.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_214.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1459,const_1463,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1456);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1461);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_678,_loc7_.width - 2,_loc7_.height - 2 - const_678);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_678);
      ...
      private function openTrainView() : void
      {
         if(this.var_214 == null)
         {
            this.var_214 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_528) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_214.showWindow(true);
            this.var_214.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc4_:* = [];
         this.var_106.groupChildrenWithTag("CMD_BUTTON",_loc4_,true);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_214 && this.var_214.getPetId() == this.var_528)
               {
                  this.var_214.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_407,this._widget.petData.ownerId);
      ...
      {
         var _loc5_:* = null;
         var _loc1_:int = const_1466;
         this.var_106.width = _loc1_;
         var _loc2_:* = [];
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1041 + const_1042;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1042;
            }
         }
         this.var_106.height = _loc4_ + const_1041;
         this.updateWindow();
      }
   }
}
