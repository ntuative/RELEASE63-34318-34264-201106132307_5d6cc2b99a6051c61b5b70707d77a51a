   ...
   public class DoorbellView
   {
      ...
      public function update() : void
      {
         ...
         if(this.var_66 != null)
         {
            ...
            {
               this.var_66.addListItem(this.createListItem(this.var_317.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
      ...
      public function createMainWindow() : void
      {
         ...
         this.var_66 = this._frame.findChildByName("user_list") as IItemListWindow;
         this._frame.visible = false;
