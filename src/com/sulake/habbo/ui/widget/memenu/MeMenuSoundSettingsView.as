package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1020:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_1021 = param1.volume;
         if(this.var_1020 != null)
         {
            this.var_1020.setValue(this.var_1021);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1019 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1023 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1024 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1022 = (_loc5_.content as BitmapData).clone();
         }
         this.var_1020 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_962));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_1021 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1022);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1019);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1024);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1023);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_961);
         }
