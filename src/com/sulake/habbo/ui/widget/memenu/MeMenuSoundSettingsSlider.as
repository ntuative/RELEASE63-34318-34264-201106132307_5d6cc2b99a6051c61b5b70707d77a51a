package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_2058:MeMenuSoundSettingsView;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_2058.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_818 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_818.width,this.var_818.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_818,this.var_818.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_819 != null)
               {
                  ...
                  this.var_1912 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
