package com.sulake.habbo.ui.handler
{
   ...
   public class PollWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetPollMessage.ANSWER,RoomWidgetPollMessage.const_503,RoomWidgetPollMessage.const_856];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPollMessage.const_856:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomSessionPollEvent.const_163);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionPollEvent.const_79:
               ...
               _loc3_.summary = _loc2_.summary;
               break;
            case RoomSessionPollEvent.const_163:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_163);
