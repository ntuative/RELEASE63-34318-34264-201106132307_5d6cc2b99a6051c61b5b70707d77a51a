package com.sulake.habbo.ui.handler
{
   ...
   public class EffectsWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            this._container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_271,this.onEffectsChanged);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         this._container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_271,this.onEffectsChanged);
      }
      ...
      {
         return [RoomWidgetRequestWidgetMessage.const_455];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_455:
               this._widget.open();
         }
         return null;
      }
