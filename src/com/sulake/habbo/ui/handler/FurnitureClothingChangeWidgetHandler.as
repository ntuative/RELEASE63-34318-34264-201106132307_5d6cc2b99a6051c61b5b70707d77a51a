package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1662:String = "hd-99999-99999.lg-270-62";
      
      private static const const_1661:String = "hd-99999-99999.ch-630-62.lg-695-62";
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_392);
         }
         this.var_1121 = true;
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_909,RoomWidgetClothingChangeMessage.const_897,RoomWidgetAvatarEditorMessage.const_605];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_909:
               ...
               break;
            case RoomWidgetClothingChangeMessage.const_897:
               ...
               if(_loc2_ != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     _loc8_ = "null";
                     _loc9_ = _loc3_.getString(RoomObjectVariableEnum.const_1222);
                     ...
                     {
                        _loc8_ = "null";
                        _loc9_ = _loc3_.getString(RoomObjectVariableEnum.const_1154);
                        if(_loc9_ == null || _loc9_ == "")
                        {
                           _loc9_ = const_1661;
                        }
                     }
                     if(this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_392,this,[AvatarEditorFigureCategory.const_281,AvatarEditorFigureCategory.const_804],false,"${widget.furni.clothingchange.editor.title}"))
                     {
                        this._container.avatarEditor.loadAvatarInEditor(AvatarEditorInstanceId.const_392,_loc9_,_loc8_,HabboClubLevelEnum.const_56);
