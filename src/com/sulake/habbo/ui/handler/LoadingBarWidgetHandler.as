package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(InterstitialEvent.const_623);
         _loc1_.push(InterstitialEvent.const_528);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_108);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_314);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_623:
               ...
               break;
            case InterstitialEvent.const_528:
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_108:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_314:
               this._container.events.dispatchEvent(param1);
         }
      }
