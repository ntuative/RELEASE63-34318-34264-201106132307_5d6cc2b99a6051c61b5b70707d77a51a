package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_832,RoomWidgetDimmerSavePresetMessage.const_986,RoomWidgetDimmerChangeStateMessage.CHANGE_STATE,RoomWidgetDimmerPreviewMessage.const_851];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_832:
               ...
               break;
            case RoomWidgetDimmerSavePresetMessage.const_986:
               if(this.validateRights())
               {
            ...
            case RoomWidgetDimmerChangeStateMessage.CHANGE_STATE:
               ...
               break;
            case RoomWidgetDimmerPreviewMessage.const_851:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionDimmerPresetsEvent.const_481);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_481:
               _loc2_ = param1 as RoomSessionDimmerPresetsEvent;
               _loc3_ = new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_860);
               ...
               while(_loc6_ < _loc2_.presetCount)
               {
                  ...
                  if(_loc7_ != null)
                  {
                     _loc3_.method_3(_loc7_.id,_loc7_.type,_loc7_.color,_loc7_.light);
                  }
                  _loc6_++;
               }
            ...
            case RoomEngineObjectEvent.const_117:
               this._container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_719));
         }
      }
