package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_925);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_894);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_1003);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_925:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_894:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_1003:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_154);
         _loc1_.push(FriendRequestEvent.const_62);
         _loc1_.push(FriendRequestEvent.const_367);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_154:
            ...
            case FriendRequestEvent.const_367:
