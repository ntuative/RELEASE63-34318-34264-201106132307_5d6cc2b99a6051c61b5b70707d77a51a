package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private static const const_713:String = "room_view";
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         this.var_3047 = param1.copy();
         this.var_99 = param2.buildFromXML(param1,0) as IWindowContainer;
         if(this.var_99 == null)
         {
            throw new Error("Failed to build layout from XML.");
         }
         this.var_99.width = this.var_99.desktop.width;
         this.var_99.height = this.var_99.desktop.height;
         var _loc4_:IWindowContainer = this.var_99.desktop as IWindowContainer;
         _loc4_.addChildAt(this.var_99,0);
         this.var_99.findChildByTag("room_widget_infostand").y = this.var_99.findChildByTag("room_widget_infostand").y - BOTTOM_MARGIN;
         var _loc6_:int = 0;
         while(_loc6_ < this.var_99.numChildren)
         {
            _loc5_ = this.var_99.getChildAt(_loc6_);
            _loc7_ = false || false;
            if(_loc5_.testParamFlag(_loc7_))
            {
               _loc5_.addEventListener(WindowEvent.const_166,this.trimContainer);
            }
            _loc6_++;
         }
      }
      ...
      private function getWidgetContainer(param1:String, param2:IWindow) : IWindowContainer
      {
         ...
         {
            return this.var_99.getChildByName("background_widgets") as IWindowContainer;
         }
         ...
         return this.var_99.getChildByTag(_loc4_) as IWindowContainer;
      }
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_99.getChildByTag(const_713) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_99.findChildByTag(const_713) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
         ...
         _loc2_.offset(this.var_99.x,this.var_99.y);
         return _loc2_;
      }
