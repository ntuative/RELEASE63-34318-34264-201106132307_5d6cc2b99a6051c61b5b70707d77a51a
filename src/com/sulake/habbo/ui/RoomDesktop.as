package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1344:IRoomWidgetFactory = null;
      
      private var var_365:ISessionDataManager = null;
      
      private var var_16:IRoomSessionManager = null;
      
      private var var_1001:IAvatarRenderManager = null;
      ...
      private var var_1332:IHabboHelp = null;
      ...
      private var var_295:DesktopLayoutManager;
      ...
      private var var_255:IToolTipWindow;
      
      private var var_2890:uint = 16777215;
      
      private var var_2891:Boolean = false;
      
      private var var_2089:int = 0;
      
      private var var_568:Timer;
      
      private var var_2088:Rectangle;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_295 = new DesktopLayoutManager();
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(this._friendList)
         {
            ...
            this._friendList.events.addEventListener(FriendRequestEvent.const_367,this.processEvent);
         }
      }
      ...
      public function set navigator(param1:IHabboNavigator) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_349,this.onNavigatorEvent);
      }
      ...
      {
         this.var_295.setLayout(param1,this._windowManager,this._config);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            ...
            this._friendList.events.removeEventListener(FriendRequestEvent.const_367,this.processEvent);
         }
         ...
         {
            this._navigator.events.removeEventListener(HabboNavigatorEvent.const_349,this.onNavigatorEvent);
         ...
         {
            this.var_568.reset();
            this.var_568.removeEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
            this.var_568 = null;
         }
         this.var_2088 = null;
      }
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_34 != null)
         {
            this.var_884 = this._roomEngine.loadRoomResources(this.var_34.roomResources);
      ...
      {
         if(this.var_348 != null && this.var_34.state == RoomSessionEvent.SESSION_CREATED)
         {
            this.var_2087 = !this.var_348.showInterstitial();
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               {
                  _loc8_ = this.var_883.getValue(_loc12_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_883.add(_loc12_,_loc8_);
                  }
                  _loc8_.push(_loc4_);
               }
            }
         }
         _loc2_ = this.var_1344.createWidget(param1,_loc4_);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            this.var_295.addWidgetWindow(param1,_loc2_.mainWindow);
         }
         if(_loc3_)
         {
            param1 = "null";
            _loc13_ = new RoomWidgetRoomViewUpdateEvent(param1,this.var_295.roomViewRect);
      ...
      public function disposeWidget(param1:String) : void
      {
         ...
         if(this.var_40 != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               {
                  this.var_295.removeWidgetWindow(param1,_loc2_.mainWindow);
               }
               _loc2_.dispose();
            }
         }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_883.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(_loc4_.getNumber(RoomObjectVariableEnum.const_1242) == 1)
               {
                  _loc2_ = true;
                  if(this.var_365.isAnyRoomController)
                  {
                     _loc2_ = false;
                  }
               }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineObjectEvent.const_496:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_156,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_182:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_991,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_194:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_448,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_993:
               if(!this.var_34.isRoomController && !this.var_365.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_144:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1361,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_162:
               ...
               this.processWidgetMessage(_loc5_);
               break;
            case RoomEngineSoundMachineEvent.const_258:
               this.processEvent(param1);
         }
         if(_loc4_ != null)
         {
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineEvent.const_614:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_431,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc21_:* = null;
         var _loc2_:Rectangle = this.var_295.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_34.roomId,this.var_34.roomCategory,RoomVariableEnum.const_754);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_34.roomId,this.var_34.roomCategory,RoomVariableEnum.const_953);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_34.roomId,this.var_34.roomCategory,RoomVariableEnum.const_940);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_34.roomId,this.var_34.roomCategory,RoomVariableEnum.const_963);
         ...
         this.var_295.addRoomView(_loc9_);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2890);
      ...
      {
         var _loc3_:IWindowContainer = this.var_295.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getRoomViewRect() : Rectangle
      {
         ...
         return this.var_295.roomViewRect;
      }
      ...
      public function canvasMouseHandler(param1:WindowEvent) : void
      {
         ...
         if(_loc3_ == MouseEvent.MOUSE_MOVE && this.var_255 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(-this.var_255.width / 2,15);
            this.var_255.setGlobalPosition(_loc8_);
         }
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_2088 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_34.roomId,this.var_34.roomCategory,this.var_342[0],_loc2_.width,_loc2_.height);
         if(this.var_568 == null)
         {
            this.var_568 = new Timer(const_1657,1);
            this.var_568.addEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
         }
         else
         {
            this.var_568.reset();
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_2088));
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_2089) / 1000);
      ...
      {
         var _loc2_:* = null;
         if(param1.type == HabboNavigatorEvent.const_349)
         {
            if(this.var_34 != null)
            {
               _loc2_ = this._roomEngine.getRoomCanvasGeometry(this.var_34.roomId,this.var_34.roomCategory,this.getFirstCanvasId());
      ...
      public function update() : void
      {
         ...
         var _loc1_:int = this.var_415.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_415.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
      ...
      {
         if(this.var_16 != null && this.var_34 != null && this.var_2087 && this.var_2086)
         {
            this.var_16.startSession(this.var_34);
            this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_314));
            return true;
         }
         return false;
      }
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_566:
               ...
               this.var_255 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_443,WindowStyle.const_106,WindowParam.const_103) as IToolTipWindow;
               this.var_255.setParamFlag(WindowParam.const_30,false);
      ...
      public function addUpdateListener(param1:IRoomWidgetHandler) : void
      {
         ...
         if(this.var_415.indexOf(param1) == -1)
         {
      ...
      public function removeUpdateListener(param1:IRoomWidgetHandler) : void
      {
         ...
         var _loc2_:int = this.var_415.indexOf(param1);
         if(_loc2_ != -1)
         {
            this.var_415.splice(_loc2_,1);
         }
      }
   }
}
