package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_474:uint = 3;
      ...
      private var var_1615:IEventDispatcher;
      
      private var var_1304:Boolean = false;
      
      private var var_2038:ProfilerOutput;
      
      private var var_1613:ProfilerAgentTask;
      
      private var var_1614:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_224 = new Array(const_474);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_474)
         {
            this.var_224[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_652 = this.var_224[const_1608];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2038)
            {
               this.var_2038 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2038.profiler = _loc3_;
            this.var_1613 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1613);
            this.var_1614 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1614);
            this.var_1304 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_224)
            {
               ...
               {
                  IDisposable(this.var_224.pop()).dispose();
               }
            }
            this.var_224 = null;
            if(this.var_289)
      ...
      {
         return this.var_652.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_652.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_289[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_289[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this.var_224[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_224[param2].getDesktopWindow();
      ...
      {
         return this.var_224[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_224[param1].getDesktopWindow().getChildAt(this.var_652.getDesktopWindow().numChildren - 1);
      }
      
      public function getWindowContext(param1:uint) : IWindowContext
      {
         return this.var_224[param1];
      }
      
      public function getDesktop(param1:uint) : IDesktopWindow
      {
         var _loc2_:IWindowContext = this.var_224[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1615.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_474 - 1;
            while(_loc2_ >= 0)
            {
               this.var_224[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1304)
         ...
         this.var_1615.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_474)
         {
            this.var_224[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1304)
         {
         ...
         this.var_1615.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1899,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1757,param2.name + ": " + param2.toString());
            }
