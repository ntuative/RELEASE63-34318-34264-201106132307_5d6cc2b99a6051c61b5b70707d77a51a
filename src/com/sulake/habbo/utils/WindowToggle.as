package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      private var var_1412:Function;
      
      private var var_924:Function;
      ...
      {
         return this.visible && this._window.getStateFlag(WindowState.const_87);
      }
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_923)
            {
               this.var_923.addChild(this._window);
            }
