package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyConfirmationDialog
   {
      ...
      public function showConfirmation() : void
      {
         ...
         var _loc2_:ICoreLocalizationManager = this.var_29.localization;
         var _loc4_:* = "";
         var _loc5_:int = this.var_29.getClubType();
         ...
         var _loc7_:IPurse = this.var_29.getPurse();
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "select_button":
               this.var_29.confirmSelection(this.var_105,this.var_1538);
               break;
