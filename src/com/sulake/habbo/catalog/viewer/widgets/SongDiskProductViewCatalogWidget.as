package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_437:IButtonWindow;
      
      private var var_1380:ITextWindow;
      
      private var var_1116:int = -1;
      
      private var var_3072:String = "";
      
      public function SongDiskProductViewCatalogWidget(param1:IWindowContainer, param2:IHabboSoundManager)
      {
         super(param1);
         this.var_437 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1380 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_437 != null)
         {
            this.var_437.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_437.disable();
         }
         this.var_1379 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
      ...
      override public function dispose() : void
      {
         if(this.var_437 != null)
         {
            this.var_437.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_207);
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_121);
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_207);
            this._soundManager.musicController.playSong(this.var_1116,HabboMusicPrioritiesEnum.const_207,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_1116 = parseInt(_loc2_.extraParam);
            if(this.var_1379 != null)
            {
               this.var_1379.visible = true;
            }
         }
         else
         {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1380.text = _loc8_;
            }
         }
         else if(this.var_1380 != null)
         {
            this.var_1380.text = "";
         }
         if(this.var_437 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_1116);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_1116);
         }
         return -1;
      }
