package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_387:IItemGridWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_387 = _window.findChildByName("colourGrid") as IItemGridWindow;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.select(this.var_387.getGridItemAt(param1.index) as IWindowContainer);
      }
      ...
      private function onAvailableMultiColours(param1:CatalogWidgetMultiColoursEvent) : void
      {
         ...
         this.var_986 = _loc5_.content as BitmapData;
         this.populateColourGrid();
         this.select(this.var_387.getGridItemAt(0) as IWindowContainer);
      }
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_987.length,this.var_387.numGridItems]);
         this.var_387.destroyGridItems();
         this.var_233 = null;
         for each(_loc1_ in this.var_987)
         {
            if(_loc1_.length > 0)
            {
               ...
               this.var_387.addGridItem(_loc2_);
               _loc3_ = _loc2_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
               if(_loc3_ != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_656.width,this.var_656.height,true,0);
                  _loc3_.bitmap.copyPixels(this.var_656,this.var_656.rect,new Point(0,0));
               }
               ...
               if(_loc5_ != null)
               {
                  _loc5_.bitmap = new BitmapData(this.var_986.width,this.var_986.height,true,16777215);
                  _loc5_.bitmap.copyPixels(this.var_986,this.var_986.rect,new Point(0,0),null,null,true);
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_387.getGridItemIndex(param1.target as IWindow);
