package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1619:String = "default";
      ...
      private var var_1618:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1070 = this.parseElements(_loc2_.floors.pattern);
         this.var_1309 = this.parseElements(_loc2_.walls.pattern);
         this.var_1312 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1070)
                  {
                     _loc11_ = this.var_1070[_loc10_];
                     if(this.var_696.indexOf(_loc10_) == -1)
                     {
                        this.var_696.push(_loc10_);
                        this.var_1310.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1309[_loc8_] != null)
                  {
                     this.var_867.push(_loc8_);
                     this.var_1311.push(_loc3_);
                  }
                  else
                  {
                  ...
                  break;
               case "landscape":
                  if(this.var_1312[_loc8_] != null)
                  {
                     this.var_868.push(_loc8_);
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1619,this.var_1618,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1311[this.var_477];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1310[this.var_478];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1618);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_696[this.var_478];
         var _loc3_:Array = this.var_1070[_loc2_];
         if(_loc3_ != null && this.var_482 >= 0)
         {
            _loc11_ = _loc3_[this.var_482];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1310[this.var_478];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_867[this.var_477];
         var _loc6_:Array = this.var_1309[_loc5_];
         if(_loc6_ != null && this.var_480 >= 0)
         {
            _loc13_ = _loc6_[this.var_480];
            if(_loc13_ != null)
            {
               this.var_1619 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1311[this.var_477];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_868[this.var_481];
         var _loc9_:Array = this.var_1312[_loc8_];
         if(_loc9_ != null && this.var_479 >= 0)
         {
            _loc15_ = _loc9_[this.var_479];
            if(_loc15_ != null)
            {
               this.var_1618 = _loc15_;
            }
         }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_112:
               ...
               if(this.var_478 < 0)
               {
                  this.var_478 = this.var_696.length - 1;
               }
               if(this.var_478 >= this.var_696.length)
               {
                  this.var_478 = 0;
               }
               this.var_482 = 0;
               this.var_1073 = 0;
               _loc5_ = this.var_696[this.var_478];
               _loc6_ = this.var_1070[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1073 = _loc6_.length;
               }
            ...
            case const_237:
               ...
               if(this.var_477 < 0)
               {
                  this.var_477 = this.var_867.length - 1;
               }
               if(this.var_477 == this.var_867.length)
               {
                  this.var_477 = 0;
               }
               this.var_480 = 0;
               this.var_1072 = 0;
               _loc7_ = this.var_867[this.var_477];
               _loc8_ = this.var_1309[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1072 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_481 < 0)
               {
                  this.var_481 = this.var_868.length - 1;
               }
               if(this.var_481 >= this.var_868.length)
               {
                  this.var_481 = 0;
               }
               this.var_479 = 0;
               this.var_1071 = 0;
               _loc9_ = this.var_868[this.var_481];
               _loc10_ = this.var_1312[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1071 = _loc10_.length;
               }
