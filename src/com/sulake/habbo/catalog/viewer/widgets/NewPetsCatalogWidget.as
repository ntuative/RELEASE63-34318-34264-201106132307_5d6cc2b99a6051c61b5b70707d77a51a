package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1593:int = 18;
      ...
      private var var_211:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_566 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_566 < 8)
         {
            return false;
         }
         ...
         if(this.var_211 != null && this.var_211.length > 0)
         {
            this.var_400 = this.var_211[0];
         }
         else
         {
            this.var_400 = -1;
         }
         this._offers.add(this.var_566,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_211 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1593 && _loc2_ < this.var_211.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_566,this.var_211[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_211 != null && this.var_211.length > 0)
         {
            if(param1 < 0 || param1 > this.var_211.length)
            {
               param1 = 0;
            }
            this.var_400 = this.var_211[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_566,this.var_400),this.getRaceLocalizationKey(this.var_566,this.var_400));
            }
         }
         return this.getRaceLocalizationKey(this.var_566,this.var_400);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_400 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_566;
         var _loc3_:int = this.var_400;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_400 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
