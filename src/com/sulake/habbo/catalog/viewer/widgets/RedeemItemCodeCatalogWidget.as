package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1063.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1063 = null;
         }
         if(this.var_1062 != null)
         {
            this.var_1062.removeEventListener(WindowKeyboardEvent.const_210,this.windowKeyEventProcessor);
            this.var_1062 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1063 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1063 != null)
         {
            this.var_1063.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1062 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1062 != null)
         {
            this.var_1062.addEventListener(WindowKeyboardEvent.const_210,this.windowKeyEventProcessor);
         }
         return true;
      }
