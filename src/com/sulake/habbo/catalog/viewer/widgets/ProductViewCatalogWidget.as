package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_527:IDisplayObjectWrapper;
      
      private var var_1738:Point;
      
      private var var_526:IItemGridWindow;
      
      private var var_1447:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_194.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_194 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_941 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1152 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_97 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_194 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_194 != null)
         {
            this.var_194.visible = false;
            this.var_527 = this.var_194.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_527 != null && _loc3_ != null)
            {
               this.var_194.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_527.width,this.var_527.height);
               if(_loc4_ != null)
               {
                  this.var_527.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1738 = new Point(this.var_97.x,this.var_97.y);
         this.var_526 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1447 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_941.text = _loc4_;
         this.var_1152.text = _loc5_;
         this.var_941.height = this.var_941.textHeight + 5;
         this.var_1152.y = this.var_941.y + this.var_941.height;
         this.var_1152.height = Math.max(130,this.var_1152.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_515:
                  ...
                  if(this.var_526 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_526,this.var_1447,this.var_1958);
               ...
               case Offer.const_387:
                  ...
                  if(this.var_194 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_72 || _loc9_.productType == ProductTypeEnum.const_63 || _loc9_.productType == ProductTypeEnum.const_179)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_72:
                        if(_loc8_ != null && this.var_527 != null)
                        {
                     ...
                     case ProductTypeEnum.const_179:
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 _loc18_.setDirection(AvatarSetType.const_52,3);
                                 _loc18_.initActionAppends();
                                 _loc18_.appendAction(AvatarAction.const_348,AvatarAction.const_626);
                                 _loc18_.appendAction(AvatarAction.const_325,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2322)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2322 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_97 != null && true)
         {
            ...
            this.var_97.x = this.var_1738.x;
            this.var_97.y = this.var_1738.y;
            if(param3 != null)
            {
