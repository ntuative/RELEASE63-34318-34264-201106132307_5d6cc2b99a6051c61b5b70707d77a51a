package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_463:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         super(param1,param2);
         this.var_463 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_463)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_463.numSelectables)
            {
               _loc4_ = this.var_463.getSelectableAt(_loc3_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_114[this.var_535]);
      ...
      {
         var _loc2_:int = this.var_686[this.var_535];
         var _loc3_:Offer = this.var_215[this.var_535][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_504.numGridItems)
         {
            _loc2_ = this.var_215[this.var_535][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_686[this.var_535] = (this.var_215[this.var_535] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_686[0];
         var _loc2_:int = this.var_686[1];
         var _loc3_:int = this.var_686[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_423 || _loc1_.pricingModel == Offer.const_387))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_63 || _loc2_.productType == ProductTypeEnum.const_72))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_463.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_463.setSelected(this.var_463.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            if(var_504)
            {
               var_504.destroyGridItems();
            }
            page.replaceOffers(this.var_215[this.var_535],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_686[this.var_535];
