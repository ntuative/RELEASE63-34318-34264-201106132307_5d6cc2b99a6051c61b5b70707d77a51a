package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubBuyCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         if(this.var_29 != null)
         {
            this.var_29.unRegisterVisualization(this);
         }
         this.var_29 = null;
         this.reset();
         super.dispose();
      ...
      override public function init() : Boolean
      {
         ...
         this.var_29 = (page.viewer.catalog as HabboCatalog).getClubBuyController();
         this.var_29.registerVisualization(this);
         this.var_29.requestOffers();
         return true;
      }
