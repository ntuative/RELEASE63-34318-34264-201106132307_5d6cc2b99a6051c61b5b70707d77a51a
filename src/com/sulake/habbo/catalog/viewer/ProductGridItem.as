package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private var var_221:IItemGrid;
      
      protected var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_563:Object;
      ...
      {
         this._view.getChildByName(const_1087).style = HabboWindowStyle.const_31;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_91,MouseCursorType.const_859);
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_44)
         {
            ...
            this.var_221.select(this);
            this.var_563 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_563 != null && this.var_563 == param2)
         {
            _loc3_ = this.var_221.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_563 = null;
            }
