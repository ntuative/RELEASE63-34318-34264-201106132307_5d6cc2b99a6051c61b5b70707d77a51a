package com.sulake.habbo.catalog.viewer
{
   ...
   public class BundleProductContainer extends ProductContainer implements IItemGrid
   {
      ...
      private static const const_1588:int = 6;
      ...
      public function BundleProductContainer(param1:Offer, param2:Array)
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1579 = _loc3_.content as BitmapData;
         }
         else
         {
            this.var_1579 = new BitmapData(1,1,true,16777215);
         }
      }
      ...
      {
         setIconImage(this.var_1579.clone(),true);
      }
      ...
      public function populateItemGrid(param1:IItemGridWindow, param2:IScrollbarWindow, param3:XML) : void
      {
         ...
         if(param2 != null)
         {
            param2.visible = offer.productContainer.products.length > const_1588;
         }
      }
