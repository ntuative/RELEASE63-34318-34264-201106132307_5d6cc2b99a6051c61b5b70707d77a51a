package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1603:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      ...
      private static const const_1096:Object = {"frontpage3":[7,8]};
      
      private static const const_1097:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      {
         if(param1 < this.var_857.length)
         {
            return this.var_857[param1];
         }
         return "";
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_857.length)
         {
            _loc2_ = String(this.var_857[param1]).replace("#","0x");
