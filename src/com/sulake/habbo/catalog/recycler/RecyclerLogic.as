package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1098:int = 0;
      ...
      {
         return this.var_694 != const_1098;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2037 != RecyclerStatusMessageEvent.const_1184;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_694 == const_473;
      }
      ...
      {
         this.var_694 = const_1099;
         this.var_135 = new Array(const_211);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_2037)
         {
            case RecyclerStatusMessageEvent.const_1843:
               this.var_694 = const_473;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1184:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1779:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1272:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1770:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_135.length < const_211)
         {
            return false;
         }
         var _loc1_:int = 0;
