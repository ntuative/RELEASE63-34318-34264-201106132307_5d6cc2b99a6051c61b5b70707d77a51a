package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_1907:IProductData;
      
      private var var_672:IFurnitureData;
      ...
      {
         this.var_1229 = param1.offerId;
         this.var_1722 = param1.productContainer.firstProduct.productClassId;
         this.var_1907 = param1.productContainer.firstProduct.productData;
         this.var_672 = param1.productContainer.firstProduct.furnitureData;
         this.var_1540 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_234,this._category,this.var_1721,this._x,this.var_176,this._direction,this.var_1229,this.var_1722].toString();
      }
