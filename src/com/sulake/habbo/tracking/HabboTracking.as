package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1129:uint = 11;
      ...
      private var var_230:IHabboFriendList;
      
      private var var_1366:IHabboWindowManager;
      ...
      private var var_722:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_722 = new LagWarningLogger();
         this.var_496 = new ToolbarClickTracker(this);
         this.var_1655 = new Array(const_1129);
         var _loc4_:int = 0;
         while(_loc4_ < const_1129)
         {
            this.var_1655[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1837,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1747,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_923,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1358,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1366)
            {
               this.var_1366.release(new IIDHabboWindowManager());
               this.var_1366 = null;
            }
            if(this.var_348)
            {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_349,this.onZoomToggle);
               }
            ...
            if(this.var_230)
            {
               ...
               {
                  Component(this.var_230).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_230).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_230).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_230).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_230).events.removeEventListener(HabboFriendListTrackingEvent.const_570,this.onFriendlistTrackingEvent);
               }
               this.var_230.release(new IIDHabboFriendList());
               this.var_230 = null;
            }
            if(this.var_207)
            {
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_319,this.onRoomAction);
               }
      ...
      {
         this.var_1655[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_169 = IHabboConfigurationManager(param2);
         if(this.var_169)
         {
            if(this.var_300 != null)
            {
               this.var_300.configuration = this.var_169;
            }
            if(this.var_299 != null)
            {
               this.var_299.configuration = this.var_169;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1751);
            if(this.var_169)
            {
               if(this.var_722 != null)
               {
                  this.var_722.configure(this.var_169);
               }
               if(this.var_495 != null)
               {
                  this.var_495.configure(this.var_169);
               }
               if(this.var_496 != null)
               {
                  this.var_496.configure(this.var_169);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_858,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_264,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_797,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_79,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_604,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_722 != null)
            {
               this.var_722.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_797)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1834);
         }
         else if(param1.type == HabboHotelViewEvent.const_604)
         {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1912);
               break;
            case HabboCommunicationEvent.const_858:
               this.trackLoginStep(HabboLoginTrackingStep.const_1766,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_264:
               this.trackLoginStep(HabboLoginTrackingStep.const_264);
               break;
      ...
      {
         this.var_1366 = IHabboWindowManager(param2);
         if(this.var_1366)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_169)
            {
               if(this.var_169.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_169.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1655)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1251);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1251,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_349,this.onZoomToggle);
      }
      ...
      {
         this.var_230 = param2 as IHabboFriendList;
         Component(this.var_230).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_230).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_230).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_230).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_230).events.addEventListener(HabboFriendListTrackingEvent.const_570,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_570:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2947)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1901);
            this.var_2947 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1358,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_923,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_319,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_348 = param2 as IAdManager;
         this.var_348.events.addEventListener(AdEvent.const_565,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_319)
         {
            if(this.var_345)
            {
               this.var_345.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
      ...
      {
         if(this.var_169 != null && !Boolean(this.var_169.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_722.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_590 > -1 && _loc2_ < this.var_590)
         {
            ++this.var_2136;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2136);
         }
         if(this.var_590 > -1 && _loc2_ - this.var_590 > 15000)
         {
            ++this.var_2135;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2135);
         }
         this.var_590 = _loc2_;
         if(this.var_299 != null)
         {
            this.var_299.update(param1,this.var_590);
         }
         if(this.var_300 != null)
         {
            this.var_300.update(param1,this.var_590);
         }
         if(this.var_495 != null)
         {
            this.var_495.trackUpdate(param1,this,this.var_590);
         }
         if(this.var_722 != null)
         {
            this.var_722.update(this.var_590);
         }
      }
   }
}
