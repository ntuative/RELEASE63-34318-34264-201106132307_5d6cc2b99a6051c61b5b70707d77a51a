package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1281 = this.var_2005.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1281)
         {
            this.var_1281.procedure = this.onButtonClick;
         }
         this.var_1282 = this.var_2005.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1282)
         {
            this.var_1282.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_284 >= this.var_70.length - 1)
         {
            this.var_1282.disable();
         }
         else
         {
            this.var_1282.enable();
         }
         if(this.var_284 <= 0)
         {
            this.var_1281.disable();
         }
         else
         {
            this.var_1281.enable();
         }
      }
      ...
      {
         ++this.var_284;
         this.var_284 = Math.min(this.var_284,this.var_70.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_70[this.var_284][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_70[this.var_284][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_70[this.var_284][1]).value;
