package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1261:Number = 1.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1261,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1031);
         }
      ...
      {
         return int(this.var_1912 * (Number(param1 - this._minValue) / (this.var_1261 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1912 * (this.var_1261 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1032)
         {
            if(param1.type == WindowMouseEvent.const_57 || param1.type == WindowMouseEvent.const_248)
            {
               this.var_1032 = false;
            }
         }
         if(!this.var_1032 || param1.type != WindowEvent.const_434)
         {
            return;
         }
         if(this.var_676 != 0)
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_676 != 0)
            {
               _loc3_ = this.var_1031 + this.var_676;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_818 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_818.width,this.var_818.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_818,this.var_818.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_819 != null)
            {
               ...
               this.var_1912 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_818 = BitmapData(_loc2_.content);
