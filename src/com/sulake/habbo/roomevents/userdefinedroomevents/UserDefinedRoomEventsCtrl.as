package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_351:int = 3;
      
      private static var var_1584:int = 2;
      ...
      private var var_1981:TriggerConfs;
      
      private var var_1980:ActionTypes;
      
      private var var_1979:ConditionTypes;
      
      private var var_282:Dictionary;
      
      private var var_38:Triggerable;
      
      private var var_847:RoomObjectHightLighter;
      
      private var var_207:UserDefinedRoomEventsHelp;
      
      private var var_1275:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1981 = new TriggerConfs();
         this.var_1980 = new ActionTypes();
         this.var_1979 = new ConditionTypes();
         this.var_282 = new Dictionary();
         super();
         this.var_92 = param1;
         this.var_847 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_282[param1])
         {
            delete this.var_282[param1];
            this.var_847.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_38.furniLimit)
         {
            this.var_282[param1] = param2;
            this.var_847.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1275 = new SliderWindowController(this.var_92,IWindowContainer(this.find(this.var_56,"delay_slider_container")),this.var_92.assets,0,20,1);
         this.var_1275.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1275.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_847.hideAll(this.var_282);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_38.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_351)
            {
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1275.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = this.var_38.stuffTypeSelectionCode < 1 ? int(var_1584) : int(this.var_38.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = (this.var_38.stuffTypeSelectionCode + 1) % (var_1584 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_351)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1981);
         this.refreshConfigureElement(this.var_1980);
         this.refreshConfigureElement(this.var_1979);
