package com.sulake.habbo.quest
{
   ...
   public class FriendlyTime
   {
      ...
      private static const const_1084:int = 3600;
      
      private static const const_1569:int = 3 * const_1083;
      
      private static const const_1568:int = 3 * const_1084;
      ...
      {
         if(param2 > const_1568)
         {
            return getLocalization(param1,"friendlytime.hours",Math.round(param2 / const_1084));
         }
         if(param2 > const_1569)
         {
            return getLocalization(param1,"friendlytime.minutes",Math.round(param2 / const_1083));
         }
