package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1642:int = 10;
      
      private static const const_1641:int = 10;
      
      private static const const_1640:int = 30;
      ...
      private var var_2075:Boolean = true;
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1639.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1639[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_66 = IItemListWindow(this._window.findChildByName("quest_list"));
         this.var_595 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_66.spacing = const_1642;
      }
      
      private function refreshEntry(param1:Boolean, param2:int, param3:QuestMessageData, param4:Boolean) : Boolean
      {
         var _loc5_:IWindowContainer = IWindowContainer(this.var_66.getListItemAt(param2));
         ...
         if(_loc5_ == null)
         {
            ...
            this.var_66.addListItem(_loc5_);
            _loc6_ = true;
         }
         if(param1)
         {
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1641;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1643;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1640;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2075 && !this.var_2074)
            {
               this.var_2075 = false;
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1562 = NextQuestTimer.const_742;
         this.refresh(true);
      }
   }
}
