package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_1039:IHabboConfigurationManager;
      
      private var var_365:ISessionDataManager;
      
      private var var_1273:FaqIndex;
      
      private var _incomingMessages:IncomingMessages;
      
      private var var_75:HelpUI;
      
      private var var_117:TutorialUI;
      
      private var var_846:HotelMergeUI;
      
      private var var_1583:CallForHelpData;
      
      private var var_2686:UserRegistry;
      
      private var var_2687:String = "";
      
      private var var_1040:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1583 = new CallForHelpData();
         this.var_2686 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1273 = new FaqIndex();
      ...
      public function hasChangedName() : Boolean
      {
         if(this.var_117)
         {
            return this.var_117.hasChangedName;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1039)
         {
            this.var_1039.release(new IIDHabboConfigurationManager());
            this.var_1039 = null;
         }
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_1039.getKey(param1,param2,param3);
      }
      ...
      {
         this.var_1583.reportedUserId = param1;
         this.var_1583.reportedUserName = param2;
         this.var_75.showUI(HabboHelpViewEnum.const_411);
      }
      ...
      {
         var _loc1_:* = false;
         if(this.var_117 == null && this._assetLibrary != null && this._windowManager != null)
         {
            _loc1_ = this.getConfigurationKey("avatar.widget.enabled","0") == "0";
            this.var_117 = new TutorialUI(this,_loc1_);
         }
      ...
      public function updateTutorial(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         this.var_117.update(param1,param2,param3);
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_117)
         {
            this.var_117.showView(TutorialUI.const_350);
         }
      }
      ...
      {
         this.var_966 = IHabboLocalizationManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),this.onConfigurationManagerReady);
      }
      
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_1039 = IHabboConfigurationManager(param2);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_75:
               ...
               if(this.var_117 != null)
               {
                  this.var_117.setRoomSessionStatus(true);
               }
               break;
            case RoomSessionEvent.const_83:
               ...
               if(this.var_117 != null)
               {
                  this.var_117.setRoomSessionStatus(false);
               }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         if(!this.var_1040)
         {
            this.var_1040 = new WelcomeScreenController(this,this._windowManager);
         }
         this.var_1040.showWelcomeScreen(param1);
      }
