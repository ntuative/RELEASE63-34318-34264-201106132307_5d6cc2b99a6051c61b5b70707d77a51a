package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1829:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106132301));
         this.var_127 = new Map();
         this.var_127.add(HabboHelpViewEnum.const_1739,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_202,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_482,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_316,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_297,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_411,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_968,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_244,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_127.add(HabboHelpViewEnum.const_1303,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_127.add(HabboHelpViewEnum.const_1284,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_127.add(HabboHelpViewEnum.const_815,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_127.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_127.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_546.length == 0 || param1 != this.var_380)
            {
               this.var_546.push(this.var_380);
            }
         }
         this.var_380 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_380);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_244:
               this.showUI(HabboHelpViewEnum.const_244);
               break;
            case CallForHelpResultEnum.const_1314:
               this.showUI(HabboHelpViewEnum.const_1284);
               break;
            case CallForHelpResultEnum.const_1288:
               this.showUI(HabboHelpViewEnum.const_1303);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_127.getValue(HabboHelpViewEnum.const_202) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_595));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_127.length)
         {
            _loc3_ = this.var_127.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_127.getValue(this.var_380);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2462 = this._window.width - _loc3_.width;
         this.var_2461 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2461;
         this._window.width = _loc1_.width + this.var_2462;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_380 == HabboHelpViewEnum.const_202)
         {
            return;
         }
         if(this.var_650.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_650.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_650.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_379.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_650[1],this.var_650[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_650[0],this.var_650[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_380 == HabboHelpViewEnum.const_202 || this.var_546.length == 0)
         {
            return;
         }
         if(this.var_379 == null)
         {
            ...
            this.var_379 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_379.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_379.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_379 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_379 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_379 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
