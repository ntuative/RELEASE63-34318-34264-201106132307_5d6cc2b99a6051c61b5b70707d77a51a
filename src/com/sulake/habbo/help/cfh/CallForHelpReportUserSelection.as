package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpReportUserSelection extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         this.var_774 = main.component.userRegistry.getRegistry();
         ...
         var i:int = 0;
         while(i < this.var_774.length)
         {
            user = this.var_774.getWithIndex(i);
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc3_ < 0 || _loc3_ > this.var_774.length)
         {
            return;
         }
         var _loc4_:UserRegistryItem = this.var_774.getWithIndex(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
