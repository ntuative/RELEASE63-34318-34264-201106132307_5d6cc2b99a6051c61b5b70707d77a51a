package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private var var_29:INameChangeUI;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            this._window = this.var_29.buildXmlWindow("welcome_name_change") as IFrameWindow;
            this._window.center();
            this._window.procedure = this.windowEventHandler;
            this.var_2034 = this._window.content.getChildAt(0) as IWindowContainer;
         }
         this.var_29.localization.registerParameter("tutorial.name_change.current","name",this.var_29.myName);
         this._window.caption = this.var_29.localization.getKey("tutorial.name_change.title.main");
      ...
      private function showSelectionView() : void
      {
         if(!this.var_861)
         {
            this.var_861 = this.var_29.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_861)
            {
               return;
            }
         ...
         this._window.caption = this.var_29.localization.getKey("tutorial.name_change.title.select");
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_862)
         {
            this.var_862 = this.var_29.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_862)
            {
               return;
            }
         ...
         this._window.caption = this.var_29.localization.getKey("tutorial.name_change.title.confirm");
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "header_button_close":
               this.var_29.showView(TutorialUI.const_100);
         }
      }
