package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1811:int = 0;
      ...
      private var var_171:IRoomManagerListener;
      
      private var var_3058:IRoomContentLoader;
      
      private var var_636:IRoomObjectFactory = null;
      
      private var var_534:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1176:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_564,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_932,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_636 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_636 == null || this.var_534 == null)
         {
            return;
         }
         this._state = const_1767;
         if(this.var_1176 != null)
         {
            _loc1_ = this.var_1176;
            this.var_1176 = null;
            this.initialize(_loc1_,this.var_171);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         this.var_1080 = 50;
         this.var_171 = param2;
         var _loc3_:Array = this.var_58.method_11();
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_.length)
         {
            _loc5_ = _loc3_[_loc4_];
            if(this.var_635.indexOf(_loc5_) < 0)
            {
               this.var_58.loadObjectContent(_loc5_,events);
               this.var_635.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1150;
         return true;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_627.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_627.push(param1);
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_627.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_627[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_534.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_534.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_636.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_636 != null)
         {
            return this.var_636.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_58.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(this.var_635.length == 0)
            {
               ...
               {
                  this.var_171.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_907;
            this.var_171.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_171 != null)
            {
               this.var_171.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_957.indexOf(_loc2_) < 0)
         {
            this.var_957.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_957.length > 0)
         {
            _loc2_ = this.var_957[0];
            this.var_957.splice(0,1);
            _loc3_ = this.var_58.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_171 != null)
               {
                  this.var_171.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_171 != null)
            {
               this.var_171.contentLoaded(_loc2_,true);
            }
            if(this.var_635.length > 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_58 == null || this.var_534 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_534.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_534.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_636.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_171 != null)
                              {
                                 this.var_171.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
