package com.sulake.room.utils
{
   public class Vector3d implements IVector3d
   {
      ...
      public function get length() : Number
      {
         ...
         {
            this._length = Math.sqrt(this._x * this._x + this.var_176 * this.var_176 + this.var_177 * this.var_177);
         }
         return this._length;
      }
      ...
      {
         return "(" + [this._x,this.var_176,this.var_177].join(",") + ")";
      }
   }
}
