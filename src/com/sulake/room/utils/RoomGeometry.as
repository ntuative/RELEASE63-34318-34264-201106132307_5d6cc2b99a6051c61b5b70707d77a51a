package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      private var var_1221:Vector3d;
      
      private var _scale:Number = 1.0;
      
      private var var_450:Number = 1.0;
      
      private var var_454:Number = 1.0;
      ...
      private var var_1868:Number = 1.0;
      
      private var var_103:Vector3d;
      
      private var var_453:Vector3d;
      
      private var var_3030:Number = -500.0;
      
      private var var_3029:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1868 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_452.assign(this.var_103);
         this.var_452.x *= this.var_450;
         this.var_452.y *= this.var_454;
         this.var_452.z *= this.var_451;
         return this.var_452;
      }
      ...
      {
         if(this.var_450 != param1 * this.var_1870)
         {
            this.var_450 = param1 * this.var_1870;
            ++this.var_175;
         }
      }
      ...
      {
         if(this.var_454 != param1 * this.var_1869)
         {
            this.var_454 = param1 * this.var_1869;
            ++this.var_175;
         }
      }
      ...
      {
         if(this.var_451 != param1 * this.var_1868)
         {
            this.var_451 = param1 * this.var_1868;
            ++this.var_175;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_103.x;
         var _loc3_:Number = this.var_103.y;
         var _loc4_:Number = this.var_103.z;
         this.var_103.assign(param1);
         this.var_103.x /= this.var_450;
         this.var_103.y /= this.var_454;
         this.var_103.z /= this.var_451;
         if(this.var_103.x != _loc2_ || this.var_103.y != _loc3_ || this.var_103.z != _loc4_)
         {
            ++this.var_175;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_453.x;
         var _loc3_:Number = this.var_453.y;
         var _loc4_:Number = this.var_453.z;
         this.var_453.assign(param1);
         this._direction.assign(param1);
         if(this.var_453.x != _loc2_ || this.var_453.y != _loc3_ || this.var_453.z != _loc4_)
         {
            ++this.var_175;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_176.assign(_loc24_);
            this.var_177.assign(_loc25_);
            this.var_1222.assign(this.var_177);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_176.assign(_loc19_);
            this.var_177.assign(_loc20_);
            this.var_1222.assign(this.var_177);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_556 != null)
         {
            ...
            this.var_556.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_556.add(_loc3_,_loc4_);
            ++this.var_175;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_556 != null)
         {
            ...
            return this.var_556.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1221.assign(_loc22_);
         }
         else
         {
            this.var_1221.assign(_loc17_);
         }
         ++this.var_175;
      }
      ...
      public function adjustLocation(param1:IVector3d, param2:Number) : void
      {
         ...
         var _loc3_:Vector3d = Vector3d.product(this.var_177,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_176);
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_177);
         return new Vector3d(_loc2_,_loc3_,_loc4_);
      }
      
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_103);
         _loc2_.x *= this.var_450;
         _loc2_.y *= this.var_454;
         _loc2_.z *= this.var_451;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1221);
         if(_loc3_ < this.var_3030 || _loc3_ > this.var_3029)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_176);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         var _loc6_:IVector3d = this.getDisplacenent(param1);
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_103);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_450;
            _loc2_.y *= this.var_454;
            _loc2_.z *= this.var_451;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1221);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_176,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_103.x * this.var_450,this.var_103.y * this.var_454,this.var_103.z * this.var_451);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_177;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_450,param2.y * this.var_454,param2.z * this.var_451);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_450,param3.y * this.var_454,param3.z * this.var_451);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_450,param4.y * this.var_454,param4.z * this.var_451);
