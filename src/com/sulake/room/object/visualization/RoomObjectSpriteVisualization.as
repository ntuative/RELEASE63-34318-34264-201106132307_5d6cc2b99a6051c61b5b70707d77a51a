package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_368:IRoomObject;
      
      private var var_850:IGraphicAssetCollection;
      
      protected var var_500:int = -1;
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_223.length > 0)
            {
               _loc1_ = this.var_223[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_850.removeReference();
         }
         this.var_850 = param1;
         if(this.var_850 != null)
         {
            this.var_850.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_223.length > param1)
         {
            _loc2_ = this.var_223[this.var_223.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
