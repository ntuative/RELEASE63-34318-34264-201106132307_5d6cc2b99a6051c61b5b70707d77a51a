package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_368:IRoomObjectController;
      ...
      {
         if(this.var_368 == param1)
         {
            return;
         }
         if(this.var_368 != null)
         {
            this.var_368.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_368 = param1;
            this.var_368.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_368 != null)
            {
               this.var_368.setLocation(param1.loc);
               this.var_368.setDirection(param1.dir);
            }
         }
      }
