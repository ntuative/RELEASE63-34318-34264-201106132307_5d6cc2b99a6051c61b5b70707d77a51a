   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_579 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_116 is BitmapDataAsset)
         {
            ...
            this.var_1535 = BitmapDataAsset(this.var_116).var_1535;
            this.var_1534 = BitmapDataAsset(this.var_116).var_1534;
            if(this._bitmap != null)
            {
               this.var_116 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1535 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1534 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
