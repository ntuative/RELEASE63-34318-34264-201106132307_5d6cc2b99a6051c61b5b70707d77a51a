package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1302:String = "AssetLibraryReady";
      
      public static const const_789:String = "AssetLibraryLoaded";
      
      public static const const_1823:String = "AssetLibraryUnloaded";
      
      public static const const_1778:String = "AssetLibraryLoadError";
      
      private static const const_674:String = "name";
      
      private static const const_1056:String = "asset";
      
      private static const const_1058:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1057:String = "library";
      
      private static var var_318:Dictionary;
      
      private static var var_1810:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_542:uint = 0;
      
      private static var var_968:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_969 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_640 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1057);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1056);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_674);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1058);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_640 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_968.splice(var_968.indexOf(this),1);
            --var_542;
            this.var_541 = null;
            this.var_969 = null;
            this.var_172 = null;
      ...
      {
         if(this.var_640 == param1.url && this.var_970)
         {
            if(!this.var_971 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_641);
            }
            this.var_971 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1302));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_969)
         {
            delete this.var_969[_loc1_];
         }
         if(this.var_45 != null)
         {
            this.var_45.dispose();
         ...
         this.var_970 = false;
         this.var_640 = null;
         dispatchEvent(new Event(AssetLibrary.const_1823));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_969[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1157,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1168,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1349,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_444;
                     this.var_446.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_446.length ? this.getAssetByName(this.var_446[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_172)
         {
            ...
            {
               return this.var_446.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_172[param1] != null || (this.var_641 != null ? this.var_641[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               ++this.var_444;
               this.var_446.push(param1);
            }
            this.var_172[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_1810.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_172)
            {
               if(this.var_172[_loc2_] == param1)
               {
                  this.var_446.splice(this.var_446.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_318.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_318[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_318[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_318)
            {
               _loc3_ = AssetTypeDeclaration(var_318[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_318)
            {
               _loc4_ = AssetTypeDeclaration(var_318[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1778));
         this.var_45 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1057);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1056);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_674) && _loc3_.attribute(const_674).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_640 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_641[param1]);
                     _loc6_ = _loc3_.child(const_1058);
