package com.sulake.core.assets
{
   ...
   public class FontAsset implements IAsset
   {
      ...
      protected var var_1789:AssetTypeDeclaration;
      
      protected var var_200:Font;
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         try
         {
            if(unknown is Class)
            {
               this.var_200 = Font(FontEnum.registerFont(unknown as Class));
            }
         }
         catch(e:Error)
         {
      ...
      public function setFromOtherAsset(param1:IAsset) : void
      {
         ...
         {
            this.var_200 = FontAsset(param1).var_200;
            return;
         }
