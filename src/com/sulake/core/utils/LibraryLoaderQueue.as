package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1919:int = 4;
      ...
      {
         return this.var_473.length + this.var_307.length;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            for each(_loc1_ in this.var_473)
            {
               _loc1_.dispose();
            }
            this.var_307 = null;
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_307.length < const_1919 && this.var_473.length > 0)
            {
               _loc1_ = this.var_473.shift();
               this.var_307.push(_loc1_);
               _loc1_.resume();
            }
         }
      }
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            index = this.var_473.indexOf(loader);
            if(index > -1)
            {
               this.var_473.splice(index,1);
            }
            index = this.var_307.indexOf(loader);
            if(index > -1)
            {
               this.var_307.splice(index,1);
            }
         }
         catch(e:Error)
         {
