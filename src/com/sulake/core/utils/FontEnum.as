package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_699:Map = new Map();
      
      private static const const_383:Map = new Map();
      
      private static var var_1267:Boolean = false;
      ...
      {
         return const_699.getValue(param1) != null;
      }
      
      public static function isEmbeddedFont(param1:String) : Boolean
      {
         return const_383.getValue(param1) != null;
      }
      ...
      public static function registerFont(param1:Class) : Font
      {
         ...
         const_383.add(_loc4_.fontName,_loc4_);
         return _loc4_;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1267)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_699.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1267 = true;
         }
      ...
      public static function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            _loc3_ = const_383.getValue(_loc2_.fontName);
            if(!_loc3_ || _loc3_.fontType != _loc2_.fontType || _loc3_.fontStyle != _loc2_.fontStyle)
            {
               const_383.add(_loc2_.fontName,_loc2_);
            }
            _loc5_++;
         }
      }
