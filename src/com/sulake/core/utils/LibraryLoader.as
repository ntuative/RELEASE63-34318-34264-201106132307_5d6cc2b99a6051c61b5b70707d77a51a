package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2010:uint = 1;
      
      protected static const const_2007:uint = 2;
      
      protected static const const_2009:uint = 4;
      
      protected static const const_2008:uint = 3;
      
      protected static const name_5:uint = 7;
      
      public static const const_1691:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1190:Boolean = false;
      
      public static const const_1919:int = 2;
      
      private static var var_1064:Array = new Array();
      
      private static var var_860:Array = new Array();
      ...
      protected var var_503:uint = 0;
      
      protected var _name:String;
      
      protected var var_1131:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_1130:Boolean = false;
      
      protected var var_3003:String = "";
      
      protected var var_3004:String = "";
      
      protected var var_2218:int;
      
      protected var var_1395:int;
      
      protected var var_1396:int;
      
      protected var var_3073:uint = 0;
      
      protected var var_3005:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1190)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_860[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_860.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_860.length < const_1919 && false)
            {
               _loc1_ = var_1064.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1131 ? uint(this.var_1395 - this.var_2218) : uint(getTimer() - this.var_2218);
      }
      ...
      {
         if(this.var_1130 && !_disposed)
         {
            this.var_1130 = false;
            if(!this.var_1131 && this.var_260)
            {
               this.var_1395 = -1;
               this.var_2218 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1131 && !_disposed && this.var_1396 > 0)
         {
            try
            {
               this.var_45.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_260,const_1691 - this.var_1396);
            if(this.var_3005)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_503 = LibraryLoader.name_5;
         ...
         if(this.var_503 == LibraryLoader.const_2008)
         {
         ...
         if(this.var_503 == LibraryLoader.name_5)
         {
