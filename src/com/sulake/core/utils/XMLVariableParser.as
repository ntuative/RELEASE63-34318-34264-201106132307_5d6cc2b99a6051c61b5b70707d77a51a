package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1829:String = "float";
      
      public static const const_35:String = "Boolean";
      
      public static const const_1805:String = "bool";
      ...
      private static const const_701:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_700:String = "value";
      
      private static const const_675:String = "true";
      
      private static const const_2048:String = "PresentHandler";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_701);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_701));
         }
         else
         {
            _loc4_ = param1.child(const_701)[0];
         }
         ...
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_700));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_700)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_263 || _loc5_ == const_140)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1829:
               return Number(param1);
            case const_35:
               return param1 == const_675 || int(param1) > 0;
            case const_1805:
               return param1 == const_675 || int(param1) > 0;
            case const_150:
               return uint(param1);
            case const_140:
               return param1.split(const_1420);
            default:
