package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1505:String = "asset-libraries";
      
      private static const const_1501:String = "library";
      
      private static const const_1503:String = "service-libraries";
      
      private static const const_1500:String = "library";
      
      private static const const_1504:String = "component-libraries";
      
      private static const const_1499:String = "library";
      
      private static const const_1507:String = "error_data";
      
      private static const const_1506:String = "error_cat";
      
      private static const const_1502:String = "error_desc";
       
      
      private var var_378:LibraryLoaderQueue;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_875:
               ...
               var_423.addChild(new ProfilerViewer(this.var_218));
               break;
            case Core.const_514:
      ...
      {
         return this.var_544 - this.getNumberOfFilesPending();
      }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1507,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1506,String(param3));
         ErrorReportStorage.setParameter(const_1502,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         if(this.var_378 == null)
         {
            this.var_378 = new LibraryLoaderQueue(_debug);
         }
         try
         {
            node = config.child(const_1505)[0];
            if(node != null)
            {
               list = node.child(const_1501);
         ...
         try
         {
            node = config.child(const_1503)[0];
            if(node != null)
            {
               list = node.child(const_1500);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         try
         {
            node = config.child(const_1504)[0];
            if(node != null)
            {
               list = node.child(const_1499);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1151);
         if(!disposed)
         {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_794)
                  {
                     this.var_794.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_544 - this.var_378.length,this.var_544,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_218 ? 0 : this.var_1501 & 0;
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_218 ? 0 : this.var_1501 & 0;
         var _loc5_:int = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_107)
         {
            ...
            {
               if(this.var_643[priority] < priority)
               {
                  ++this.var_643[priority];
                  skip = true;
               }
            }
            if(!skip)
