package com.sulake.core.runtime.events
{
   ...
   public class EventListenerStruct
   {
      ...
      {
         super();
         this.var_151 = new Dictionary(param4);
      ...
      {
         var _loc2_:* = null;
         for(_loc2_ in this.var_151)
         {
            delete this.var_151[_loc2_];
         }
         this.var_151[param1] = null;
      }
