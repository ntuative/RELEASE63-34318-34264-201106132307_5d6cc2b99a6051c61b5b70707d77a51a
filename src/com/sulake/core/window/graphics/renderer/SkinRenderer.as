package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_599:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_599)
            {
               ISkinLayout(this.var_599[_loc1_]).dispose();
               delete this.var_599[_loc1_];
            }
            this.var_599 = null;
            this.var_505 = null;
      ...
      {
         var _loc3_:ISkinLayout = this.var_599[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_599[param1.name] = param1;
         return param1;
      }
      
      public function getLayoutByName(param1:String) : ISkinLayout
      {
         return this.var_599[param1];
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_599[param1.name];
         }
         return param1;
      }
