package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_70:String = "locked";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_349 = SkinLayoutEntity.const_492;
                  break;
               case "move":
                  _loc5_.var_349 = SkinLayoutEntity.const_358;
                  break;
               case "strech":
                  _loc5_.var_349 = SkinLayoutEntity.const_613;
                  break;
               case "tiled":
                  _loc5_.var_349 = SkinLayoutEntity.const_375;
                  break;
               case "center":
                  _loc5_.var_349 = SkinLayoutEntity.const_635;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_350 = SkinLayoutEntity.const_492;
                  break;
               case "move":
                  _loc5_.var_350 = SkinLayoutEntity.const_358;
                  break;
               case "strech":
                  _loc5_.var_350 = SkinLayoutEntity.const_613;
                  break;
               case "tiled":
                  _loc5_.var_350 = SkinLayoutEntity.const_375;
                  break;
               case "center":
                  _loc5_.var_350 = SkinLayoutEntity.const_635;
            }
         }
