package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1964:uint = 0;
      
      public static const const_1007:uint = 1;
      
      public static const const_1260:uint = 2;
      
      public static const const_971:uint = 4;
      
      public static const const_1864:uint = 8;
      
      public static const const_1780:uint = 16;
      
      public static const const_2111:uint = 64;
      
      public static const const_2216:uint = 128;
      
      public static const const_1164:uint = 256;
      ...
      protected var var_232:DisplayObjectContainer;
         ...
         if(this.var_916)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2213,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2213,16777215);
                  }
                  var_356 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_232 == null)
         {
            ...
            this.var_232.name = this.name + " - Child Container";
            this.var_232.mouseEnabled = false;
            addChild(this.var_232);
         }
         return this.var_232;
      }
      ...
      {
         return this.var_232 != null ? int(this.var_232.numChildren) : 0;
      }
