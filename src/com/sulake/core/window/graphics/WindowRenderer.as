package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_2036 = new Point();
         this.var_1612 = new Rectangle();
         this.var_330 = new Rectangle();
         this.var_406 = new Dictionary(true);
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_330.x = param2.x - param1.x;
            this.var_330.y = param2.y - param1.y;
            this.var_330.width = param2.width;
            this.var_330.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_33))
            {
               while(param1.testParamFlag(WindowParam.const_33))
               {
                  ...
                  this.var_330.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_330,WindowRedrawFlag.const_1311);
            if(this.var_865.indexOf(param1) == -1)
            {
      ...
      {
         var _loc2_:WindowRendererItem = this.var_406[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_406[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            this.var_406[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_855,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_855,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_406[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_406[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_865.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_865.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_330.x = _loc3_.dirty.x;
               this.var_330.y = _loc3_.dirty.y;
               this.var_330.width = _loc3_.dirty.width;
               this.var_330.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_330,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_2036,this.var_1612))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_2036,this.var_1612))
               {
