package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_738:Number;
      
      protected var var_739:Number;
      ...
      protected var var_2225:Boolean = false;
      
      protected var var_600:Boolean = false;
      
      protected var _spacing:int = 0;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_740:Number = -1.0;
      
      protected var var_741:Number = -1.0;
      ...
      protected var var_2226:int = 0;
      
      protected var var_2227:int = 0;
      
      protected var var_1401:Number;
      
      protected var var_1404:Number;
      
      protected var var_1402:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this._container = _context.create("_CONTAINER","",WindowType.const_400,WindowStyle.const_106,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_39,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_440,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_166,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_223,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1403;
      }
      ...
      {
         return new Rectangle(this.var_738 * this.maxScrollH,this.var_739 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_738 = param1;
            this._container.x = -this.var_738 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_61);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_607,this,null);
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         if(param1 != this.var_739)
         {
            this.var_739 = param1;
            this._container.y = -this.var_739 * this.maxScrollV;
            _loc2_ = WindowEvent.allocate(WindowEvent.const_607,this,null);
            _events.dispatchEvent(_loc2_);
            _loc2_.recycle();
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_640,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_440,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_166,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_223,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_44:
               this.var_2226 = _loc3_;
               this.var_2227 = _loc4_;
               this.var_1401 = 0;
               this.var_1404 = 0;
               this.var_1402 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_185:
               if(this.var_1402)
               {
                  this.var_1401 = this.var_2226 - _loc3_;
                  this.var_1404 = this.var_2227 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1401 != 0 && this.var_122 != 0)
                     {
                        this.scrollH += this.var_1401 / this.var_122;
                     }
                  }
                  else if(this.var_1404 != 0 && this.var_107 != 0)
                  {
                     this.scrollV += this.var_1404 / this.var_107;
                  }
                  this.var_2226 = _loc3_;
                  this.var_2227 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_248:
               if(this.var_1402)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1401,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1404);
                  }
                  this.var_1402 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1134 && !this.var_600 && this._container)
         {
            this.var_600 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_990)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_406,this._spacing,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1341);
         }
         if(this.var_1134 != PropertyDefaults.const_1263)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_798,this.var_1134,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1720);
         }
         if(this.var_506 != PropertyDefaults.const_1196)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_918,this.var_506,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1977);
         }
         if(this.var_1403 != PropertyDefaults.const_1153)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_865,this.var_1403,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1734);
         }
         if(this.var_740 != PropertyDefaults.const_1338)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_751,this.var_740,PropertyStruct.const_130,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1702);
         }
         if(this.var_741 != PropertyDefaults.const_1217)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_863,this.var_741,PropertyStruct.const_130,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_406:
                  ...
                  break;
               case PropertyDefaults.const_918:
               ...
               case PropertyDefaults.const_798:
                  this.var_1134 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_751:
                  this.var_740 = _loc2_.value as Number;
                  break;
               case PropertyDefaults.const_863:
                  this.var_741 = _loc2_.value as Number;
                  break;
            }
         }
