package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_992:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1905:StyleSheet = null;
      ...
      {
         this.var_814 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1227 == param2)
         {
            return;
         }
         param1.var_1227 = param2;
         param1.var_1905 = null;
         if(param1.var_1227 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1227);
            param1.var_1905 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_777.indexOf(param1) > -1)
         {
            this.var_814 = param1;
         }
      }
      ...
      {
         return this.var_814 == LinkTarget.const_31 ? defaultLinkTarget : this.var_814;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1905;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1174)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_814 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_812,this.var_814,PropertyStruct.const_51,true,PropertyDefaults.const_777));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1869);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_812)
            {
               this.var_814 = _loc2_.value as String;
               break;
            }
