package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1294:IItemListWindow;
      
      private var var_474:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_474)
         {
            this.var_474.removeEventListener(WindowEvent.const_308,this.scrollBarEventProc);
            this.var_474.removeEventListener(WindowEvent.const_273,this.scrollBarEventProc);
            this.var_474 = null;
         }
         if(this.var_1294)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1294)
         {
            this.var_1294 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_474)
         {
            this.var_474 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_474)
            {
               this.var_474.addEventListener(WindowEvent.const_308,this.scrollBarEventProc);
               this.var_474.addEventListener(WindowEvent.const_273,this.scrollBarEventProc);
            }
         }
         return this.var_474;
      }
