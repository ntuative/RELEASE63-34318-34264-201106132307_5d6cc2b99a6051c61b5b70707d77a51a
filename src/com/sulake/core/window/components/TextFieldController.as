package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1685:uint = 500;
      
      protected var var_1406:String = "";
      
      protected var var_1392:Boolean = false;
      
      protected var var_821:Boolean = false;
      ...
      {
         this.var_1406 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1260,var_11);
         }
         return var_22;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_821 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_210,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_456,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_373,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_753,false,PropertyStruct.const_35,true) : PropertyDefaults.const_1908);
         _loc1_.push(this.var_1392 != PropertyDefaults.const_1246 ? new PropertyStruct(PropertyDefaults.const_998,this.var_1392,PropertyStruct.const_35,true) : PropertyDefaults.const_1927);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1355 ? new PropertyStruct(PropertyDefaults.const_759,_field.selectable,PropertyStruct.const_35,true) : PropertyDefaults.const_1777);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1180 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_35,true) : PropertyDefaults.const_1759);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_998:
                  this.var_1392 = _loc2_.value as Boolean;
                  if(this.var_1392)
                  {
               ...
               case PropertyDefaults.const_753:
                  ...
                  break;
               case PropertyDefaults.const_1262:
