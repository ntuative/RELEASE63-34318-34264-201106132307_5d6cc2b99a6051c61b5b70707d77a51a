package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1565:String = "_TITLE";
      
      private static const const_1579:String = "_HEADER";
      
      private static const const_1580:String = "_CONTENT";
      
      private static const const_1581:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1573:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1565) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1573 = findChildByTag(const_1579) as IHeaderWindow;
            if(!this.var_1573)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_200 = findChildByTag(const_1580) as IWindowContainer;
            if(!this.var_200)
            {
      ...
      {
         return findChildByTag(const_1581) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1385,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1131 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_275);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_287);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_275,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_275,false);
            }
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_287,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_287,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_327,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_279,_loc3_.left,PropertyStruct.const_40,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_245,_loc3_.top,PropertyStruct.const_40,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_302,0 - _loc3_.right,PropertyStruct.const_40,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_253,0 - _loc3_.bottom,PropertyStruct.const_40,_loc2_));
         return _loc1_;
      }
