package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1685 = PropertyDefaults.const_874;
         this.var_1406 = PropertyDefaults.const_454;
         param4 |= 0;
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_454)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_185)
            {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_454)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_787,param1.toolTipCaption,PropertyStruct.const_51,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1693);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_874)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_770,param1.toolTipDelay,PropertyStruct.const_276,true));
         }
         else
         {
      ...
      {
         this.var_1406 = param1 == null ? "null" : param1;
      }
