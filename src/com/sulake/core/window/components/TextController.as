package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1383:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_915:Number;
      
      protected var var_595:Number;
      
      protected var var_596:Boolean;
      
      protected var var_44:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_143:Boolean = false;
      
      protected var var_1128:Boolean = false;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_203);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_850 ? true : null;
         }
      ...
      {
         this.var_915 = param1;
         this._field.scrollH = this.var_915 * Number(this._field.maxScrollH);
         this.refreshTextImage();
      }
      
      public function set scrollV(param1:Number) : void
      {
         if(param1 > this.var_595)
         {
            this.var_595 = param1;
            this._field.scrollV = Math.max(this._field.scrollV,param1 * this._field.maxScrollV + 1);
            this.refreshTextImage();
         }
         else if(param1 < this.var_595)
         {
            this.var_595 = param1;
      ...
      {
         return new Rectangle(this.var_915 * this.maxScrollH,this.var_595 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_717,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1175));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1300 ? new PropertyStruct(PropertyDefaults.const_779,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1351) : PropertyDefaults.const_1821);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_35,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_150,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_276,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1170 ? new PropertyStruct(PropertyDefaults.const_1148,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1310) : PropertyDefaults.const_1969);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_785) ? new PropertyStruct(PropertyDefaults.const_420,this._field.textColor,PropertyStruct.const_150,true) : PropertyDefaults.const_1352);
         _loc1_.push(this.var_458 != TextStyleManager.const_203 ? new PropertyStruct(PropertyDefaults.const_421,this.var_458,PropertyStruct.const_51,true,PropertyDefaults.const_755) : PropertyDefaults.const_1204);
         _loc1_.push(this.var_44.left != PropertyDefaults.const_852 ? new PropertyStruct(PropertyDefaults.const_279,this.var_44.left,PropertyStruct.const_40,true) : PropertyDefaults.const_771);
         _loc1_.push(this.var_44.top != PropertyDefaults.const_873 ? new PropertyStruct(PropertyDefaults.const_245,this.var_44.top,PropertyStruct.const_40,true) : PropertyDefaults.const_778);
         _loc1_.push(this.var_44.right != PropertyDefaults.const_915 ? new PropertyStruct(PropertyDefaults.const_302,this.var_44.right,PropertyStruct.const_40,true) : PropertyDefaults.const_732);
         _loc1_.push(this.var_44.bottom != PropertyDefaults.const_731 ? new PropertyStruct(PropertyDefaults.const_253,this.var_44.bottom,PropertyStruct.const_40,true) : PropertyDefaults.const_928);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1276 ? new PropertyStruct(PropertyDefaults.const_987,this._field.mouseWheelEnabled,PropertyStruct.const_35,true) : PropertyDefaults.const_1870);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_130,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_130,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_130,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
