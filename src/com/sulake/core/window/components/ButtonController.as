package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_1388:Number = 0.5;
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(TEXT_FIELD_NAME);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               ...
               case WindowEvent.const_308:
                  try
                  {
                     getChildByName(TEXT_FIELD_NAME).blend = getChildByName(TEXT_FIELD_NAME).blend + const_1388;
                  }
                  catch(e:Error)
                  {
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1283:
                  type = "null";
                  break;
               case WindowTouchEvent.const_836:
                  type = "null";
            }
