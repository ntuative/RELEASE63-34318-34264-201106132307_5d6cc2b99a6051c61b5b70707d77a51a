package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2767 = _loc2_.textWidth;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_405 != _loc2_.color : this.var_405 != null && this.var_405 != PropertyDefaults.const_785) ? new PropertyStruct(PropertyDefaults.const_420,this.var_405,PropertyStruct.const_150,true) : PropertyDefaults.const_1352);
         if(this.var_44)
         {
            if(this.var_44.left != PropertyDefaults.const_852)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_279,this.var_44.left,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_771);
            }
            if(this.var_44.top != PropertyDefaults.const_873)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_245,this.var_44.top,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_778);
            }
            if(this.var_44.right != PropertyDefaults.const_915)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_302,this.var_44.right,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_732);
            }
            if(this.var_44.bottom != PropertyDefaults.const_731)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_253,this.var_44.bottom,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_928);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_421:
                  ...
                  break;
               case PropertyDefaults.const_420:
