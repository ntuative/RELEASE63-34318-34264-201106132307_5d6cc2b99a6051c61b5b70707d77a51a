package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2025:String = "_POINTER_UP";
      
      private static const const_2023:String = "_POINTER_DOWN";
      
      private static const const_2024:String = "_POINTER_LEFT";
      
      private static const const_2026:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_964,this._direction,PropertyStruct.const_51,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1859);
         }
         return _loc1_;
      }
