package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1435:String = "_SELECTOR";
      
      private static const const_1436:String = "_CONTENT";
       
      
      protected var var_1123:ITabSelectorWindow;
      
      protected var var_2209:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1123 = findChildByTag(const_1435) as ITabSelectorWindow;
            if(this.var_1123 != null)
            {
               this.var_1123.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2209 == null)
         {
            this.var_2209 = findChildByTag(const_1436) as IWindowContainer;
         }
      ...
      {
         return !!this.var_821 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1123.numSelectables;
      }
