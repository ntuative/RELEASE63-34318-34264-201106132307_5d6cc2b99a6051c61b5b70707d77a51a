package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1264:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1385:String = "_COLORIZE";
      
      protected static const const_1384:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1086:Point = new Point();
      ...
      protected var var_736:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            ...
            var_508 = _loc13_.var_2991;
            if(var_507 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_261 != _loc13_.color)
            {
               this.color = _loc13_.color;
            }
            if(_loc13_.hasRectLimits())
            {
               var_80.assign(_loc13_.width_min,_loc13_.width_max,_loc13_.height_min,_loc13_.height_max);
            }
         }
         if(param9)
         {
      ...
      {
         return this.var_736 != null ? this.var_736 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_507 = param1;
         var_261 = !!var_507 ? uint(var_261 | var_601) : uint(var_261 & 16777215);
      ...
      {
         var_601 = param1 & 4278190080;
         var_261 = !!var_507 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_61);
      }
      ...
      {
         var_601 = param1 << 24;
         var_261 = !!var_507 ? uint(var_601 | var_261) : uint(16777215 & var_261);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_61);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1258);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_884);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_89)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1384) == -1)
               {
                  _loc4_.style = var_89;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_488,this,this._parent);
            ...
            else
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1802,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1007,var_11);
            this.var_22.visible = var_327;
         }
         return this.var_22;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_89,var_21,_context,var_11,null,this.var_736,this.properties,var_921.concat(),_id) as WindowController;
         ...
         _loc2_.var_80 = !!var_80 ? var_80.clone(_loc2_) : null;
         _loc2_._context = _context;
         _loc2_.var_261 = var_261;
         _loc2_.var_601 = var_601;
         _loc2_.var_742 = var_742;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2643 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         param4 = Math.max(var_80.minHeight,param4);
         param4 = Math.min(var_80.maxHeight,param4);
         param3 = Math.max(var_80.minWidth,param3);
         param3 = Math.min(var_80.maxWidth,param3);
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_509)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_609)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_21 & 0);
            if(_loc7_ == WindowParam.const_659)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_506)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1275,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_434,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_901))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_44:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1346;
                  if(testParamFlag(WindowParam.const_435))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_246))
                        {
               ...
               case WindowMouseEvent.const_57:
                  ...
                  if(testParamFlag(WindowParam.const_246))
                  {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_39:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_775,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_216,WindowParam.const_175))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_217,WindowParam.const_184))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        var_21 = _loc7_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_166,this._parent,this);
               ...
               case WindowEvent.const_434:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1189);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1700,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_223,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_501:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1214,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_331,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_488:
                  if(testParamFlag(WindowParam.const_216,WindowParam.const_175))
                  {
                     this.updateScaleRelativeToParent();
                  }
               ...
               case WindowEvent.const_440:
                  break;
               case WindowEvent.const_331:
                  this.activate();
                  break;
               case WindowEvent.const_166:
                  if(testParamFlag(WindowParam.WINDOW_PARAM_RESIZE_TO_ACCOMMODATE_CHILDREN))
                  {
                     expandToAccommodateChild(this,param2.related);
                  }
                  break;
               case WindowEvent.const_223:
                  if(testParamFlag(WindowParam.WINDOW_PARAM_RESIZE_TO_ACCOMMODATE_CHILDREN))
                  {
                     expandToAccommodateChild(this,param2.related);
                  }
         ...
         if(this.var_189 && var_508 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1086,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1086,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         var _loc7_:*;
         var_89 = !!param2 ? (_loc7_ = var_89 | param1, var_89 |= param1, uint(_loc7_)) : (_loc7_ = var_89 & ~param1, var_89 &= ~param1, uint(_loc7_));
         if(var_89 != _loc3_)
         {
            _loc4_ = new Array();
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1384) == -1)
               {
                  _loc6_.style = var_89;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_141,WindowParam.const_175);
         var _loc2_:* = !testParamFlag(WindowParam.const_168,WindowParam.const_184);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_437)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_410)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               ...
               _loc5_ = uint(var_21 & 0);
               if(_loc5_ == WindowParam.const_354)
               {
               ...
               else if(_loc5_ == WindowParam.const_217)
               {
      ...
      {
         if(_state == WindowState.const_497)
         {
            return true;
         }
         _state = WindowState.const_497;
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1988,this,null);
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1887,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1951,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1865,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1875,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_636,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1719,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_70,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1976,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1924,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_926,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_308,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1816,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1758,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_522,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_522,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_440,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
