package com.sulake.core.window.events
{
   ...
   public class WindowMouseEvent extends WindowEvent
   {
      ...
      public static const const_2217:String = "WME_MIDDLE_CLICK";
      
      public static const const_2182:String = "WME_MIDDLE_DOWN";
      
      public static const const_2252:String = "WME_MIDDLE_UP";
      
      public static const const_185:String = "WME_MOVE";
      ...
      public static const const_2082:String = "WME_RIGHT_CLICK";
      
      public static const const_2076:String = "WME_RIGHT_DOWN";
      
      public static const const_2241:String = "WME_RIGHT_UP";
      
      public static const const_1922:String = "WME_ROLL_OUT";
      
      public static const const_1986:String = "WME_ROLL_OVER";
      
      public static const const_2079:String = "WME_HOVERING";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:int) : WindowMouseEvent
      {
         ...
         _loc13_.var_732 = param3;
         _loc13_.var_162 = false;
         _loc13_.var_733 = POOL;
      ...
      {
         return "WindowMouseEvent { type: " + _type + " cancelable: " + var_499 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
