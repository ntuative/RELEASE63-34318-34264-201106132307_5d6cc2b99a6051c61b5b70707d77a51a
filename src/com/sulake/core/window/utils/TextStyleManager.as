package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_203:String = "regular";
      ...
      private static var var_517:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_669:String = "{";
      
      private static const const_670:String = "}";
      
      private static const const_1404:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_96[const_203],var_96[ITALIC],var_96[BOLD]];
            var_96.reset();
            var_96[const_203] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_517.indexOf(_loc4_.name) == -1)
            {
               var_517.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_670);
         if(countSubStrings(param1,const_669) != countSubStrings(param1,const_670))
         {
            throw new Error("Mismatching amount of \"" + const_669 + "\" versus \"" + const_670 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1404) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1403) + 2,_loc5_.length);
            }
