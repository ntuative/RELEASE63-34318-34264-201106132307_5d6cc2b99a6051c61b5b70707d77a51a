package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1370:String = "_EXCLUDE";
      
      public static const const_2124:String = "_INCLUDE";
      
      public static const const_2145:String = "_TEMP";
      
      private static const const_1425:String = "layout";
      
      private static const const_1038:String = "window";
      
      private static const const_1037:String = "variables";
      
      private static const const_1036:String = "filters";
      
      private static const const_674:String = "name";
      
      private static const const_1424:String = "style";
      
      private static const const_676:String = "params";
      
      private static const const_1430:String = "tags";
      ...
      private static const const_1418:String = "visible";
      
      private static const const_1427:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1258:String = "blend";
      
      private static const const_1426:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1429:String = "treshold";
      
      private static const const_1421:String = "children";
      
      private static const const_1423:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1419:String = "height_min";
      
      private static const const_1428:String = "height_max";
      
      private static const const_675:String = "true";
      
      private static const const_181:String = "0";
      
      private static const const_1432:String = "$";
      
      private static const const_1420:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1422:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      protected var var_1390:Dictionary;
      
      protected var var_1122:Dictionary;
      
      protected var var_1675:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1390 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1389,this.var_1390);
         this.var_1122 = new Dictionary();
         this.var_1675 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1122,this.var_1675);
         this.var_2208 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1431,const_50);
         return param1.replace(const_1422,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1390)
            {
               delete this.var_1390[_loc1_];
            }
            for(_loc1_ in this.var_1122)
            {
               delete this.var_1122[_loc1_];
            }
            for(_loc1_ in this.var_1675)
            {
               delete this.var_1675[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1425)
         {
            _loc8_ = param1.child(const_1037);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1036).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1038);
         ...
         if(param1.localName() == const_1038)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1389[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_674,variables,"")));
         style = uint(this.parseAttribute(xml,const_1424,variables,style));
         params = uint(this.parseAttribute(xml,const_676,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1430,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_181));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_181));
         rect.width = Number(this.parseAttribute(xml,name_2,variables,const_181));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_181));
         visible = this.parseAttribute(xml,const_1418,variables,visible.toString()) == const_675;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_676).length() > 0)
         {
            list = xml.child(const_676).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_674,variables,"") as String;
               if(this.var_1122[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_674)) + "\"!");
               }
               params |= this.var_1122[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1427,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1420);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1037)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1423,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1419,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1428,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_675;
         blend = Number(this.parseAttribute(xml,const_1258,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1426,variables,window.clipping.toString()) == const_675;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1429,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1036).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_217)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1390[param1.type];
         ...
         if(param1.filters && param1.filters.length > 0)
         {
            ...
            {
               _loc2_ += "\t\t" + this.method_8(_loc15_) + "\r";
            }
            _loc2_ += "\t</filters>\r";
         }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1370) == -1)
                  {
