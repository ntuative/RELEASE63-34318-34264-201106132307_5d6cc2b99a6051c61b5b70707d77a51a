package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1913:IConnectionStateListener;
      ...
      override public function dispose() : void
      {
         ...
         this.var_820 = null;
         for each(_loc3_ in this.var_1542)
         {
         }
         var _loc5_:* = null;
         this.var_1232 = null;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_1191:
               _loc3_ = new SocketConnection(param1,this,this.var_1913);
               break;
            default:
      ...
      {
         var _loc2_:Class = this.var_1232[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in this.var_1542)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
