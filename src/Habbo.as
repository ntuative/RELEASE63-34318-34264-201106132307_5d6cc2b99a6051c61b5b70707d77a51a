package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public function Habbo()
      {
         ...
         root.loaderInfo.addEventListener(ProgressEvent.PROGRESS,this.method_1);
      ...
      {
         trackLoginStep(const_8);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + this.var_9,const_9,null);
      }
      ...
      private function finalizePreloading() : void
      {
         ...
         if(!this.var_7)
         {
            ...
            root.loaderInfo.removeEventListener(ProgressEvent.PROGRESS,this.method_1);
